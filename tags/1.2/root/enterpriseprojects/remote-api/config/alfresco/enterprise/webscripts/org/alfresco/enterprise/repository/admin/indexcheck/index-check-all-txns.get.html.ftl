...
<html xmlns="http://www.w3.org/1999/xhtml">
  <@wsLib.head>Alfresco DM Index Check - all txn (running on: ${ipAddress})</@wsLib.head>
  <body>
    <div>
    <@wsLib.header>Alfresco DM Index/Txn Consistency Check - all txn (running on: <b>${ipAddress}</b>)</@wsLib.header>
    <br/>
    <#if indexTxnInfo.missingCount == 0> 
Alfresco ADM Index Check - all ${indexTxnInfo.processedCount?c} processed transaction ids are IN-SYNC with local indexes
    <#else>
