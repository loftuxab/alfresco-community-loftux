...
<@page title=msg("ldap.authentication.page.title", urldecode(args.id)) dialog=true>
   ...
   <div class="column-right">
      <@attroptions attribute=attributes["ldap.authentication.java.naming.security.authentication"] label=msg("ldap.authentication.java.naming.security.authentication")>
   ...
   <div class="column-full">
      <@tsection label=msg("ldap.synchronization-advanced.section")>
         ...
         <div class="column-right">
            ...
            <@attrtext attribute=attributes["ldap.synchronization.attributeBatchSize"] label=msg("ldap.synchronization.attributeBatchSize") description=msg("ldap.synchronization.attributeBatchSize.description") />
