...
public class OLEServerPropertiesInjector implements OLEFileProcessor
{
    ...
    public ContentFilterProcessingResult execute(POIFSFileSystem oleFS, NodeRef nodeRef)
    {
        ...
        try
        {
            DocumentMetadataProcessor.embedMetadata(oleFS, serverMetadata);
        }
        catch (HPSFException | IOException e)
        {
