...
public class ContextResponder extends HttpServlet
{

    private static final long serialVersionUID = 1868569052287663402L;
    ...
    {
        logger.debug("ContextResponder.doOptions authUser="+authenticationService.getCurrentUserName());
    ...
    {
        logger.debug("ContextResponder.doPropfind authUser="+authenticationService.getCurrentUserName());
        ServiceFilter.appendResponseHeaders(response);
        ...
        {
            out.println("  <D:response>");
            out.println("    <D:href>" + serverUrl + request.getContextPath() + Const.DEFAULT_SITE_PATH_IN_CONTEXT + "</D:href>");
            out.println("    <D:propstat>");
            out.println("      <D:prop>");
            out.println("        <D:displayname></D:displayname>");
            out.println("        <D:lockdiscovery/>");
            ...
            out.println("  </D:response>");
            out.println("  <D:response>");
            out.println("    <D:href>" + serverUrl + request.getContextPath() + "/webdav</D:href>");
            out.println("    <D:propstat>");
            out.println("      <D:prop>");
            out.println("        <D:displayname></D:displayname>");
            out.println("        <D:lockdiscovery/>");
