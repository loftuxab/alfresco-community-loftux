...
package org.alfresco.enterprise.repo.officeservices.auth;
...
public class AuthenticationFilter extends BaseAuthenticationFilter implements DependencyInjectedFilter
{
    ...
    private static final String BASIC_AUTH_REALM = "Alfresco AOS";
    
    private static final String BASIC_AUTH_REQUEST = BASIC_CHALLENGE_NAME + " realm=\"" + BASIC_AUTH_REALM + "\"";
            ...
            throws IOException, ServletException
    {
        ...
        // Always append server type header - even for unauthenticated requests
        httpResp.addHeader("MicrosoftSharePointTeamServices", "14.0.0.4730");
        //httpResp.addHeader("MicrosoftSharePointTeamServices", "12.0.0.4518");
        ...
        if (user == null)
        {
            ...
            if ( authHdr != null && authHdr.length() > 5 && authHdr.substring(0,5).equalsIgnoreCase(BASIC_CHALLENGE_NAME))
            {
                if (logger.isDebugEnabled())
            ...
            if (user == null)
            {
                ...
                httpResp.setHeader("WWW-Authenticate", BASIC_AUTH_REQUEST);
