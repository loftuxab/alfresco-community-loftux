 ...
 *
 */
public class PatchCheck implements PatchCheckMBean
{
    private OptionalPatchApplicationCheckBootstrapBean optionalPatchApplicationCheckBootstrapBean;
    ...
    /* (non-Javadoc)
     * @see org.alfresco.enterprise.repo.management.PatchCheckMBean#getPatchId()
     */
    @Override
    public String getPatchId()
    {
        return optionalPatchApplicationCheckBootstrapBean.getPatchId();
    }

    public boolean getApplied()
    {
        return optionalPatchApplicationCheckBootstrapBean.getPatchApplied();
    }
