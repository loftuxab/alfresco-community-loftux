...
(
   ...
   content_url_crc NUMBER(19,0) NOT NULL,
   content_size NUMBER(19,0) NOT NULL,
   orphan_time NUMBER(19,0) NULL,
   PRIMARY KEY (id)
);
...
(
   id NUMBER(19,0) NOT NULL,
   version NUMBER(19,0) NOT NULL,
   content_url_id NUMBER(19,0) NULL,
   content_mimetype_id NUMBER(19,0) NULL,
   content_encoding_id NUMBER(19,0) NULL,
   content_locale_id NUMBER(19,0) NULL,
