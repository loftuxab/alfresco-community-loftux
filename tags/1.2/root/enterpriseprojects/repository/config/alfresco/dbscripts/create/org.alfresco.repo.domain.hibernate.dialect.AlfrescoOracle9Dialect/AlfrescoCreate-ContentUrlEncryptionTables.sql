...
(
   ...
   content_url_id NUMBER(19,0) NOT NULL,
   algorithm VARCHAR(10 CHAR) NOT NULL,
   key_size NUMBER(10,0) NOT NULL,
   encrypted_key BLOB NOT NULL,
   master_keystore_id VARCHAR(20 CHAR) NOT NULL,
   master_key_alias VARCHAR(15 CHAR) NOT NULL,
   unencrypted_file_size NUMBER(19,0) NULL,
