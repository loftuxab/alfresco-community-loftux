 ...
 * @author janv
 */
public class EnterpriseRepoJettyStopTest extends TestCase
{
    public void testStopJetty() throws Exception
    {
        try
        {
            ...
            Socket s = new Socket(InetAddress.getByName(EnterpriseRepoJettyStartTest.JETTY_LOCAL_IP), EnterpriseRepoJettyStartTest.JETTY_STOP_PORT);
