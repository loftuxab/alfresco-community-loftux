// This file's contents are taken from the RemoteAPI project and they are unchanged (14-Nov-11) save for additional calls
...
function main()
{
   try
   {
      ...
      else
      {
         ...
         if (existingFile !== null)
         {
            ...
            if (existingFile.hasAspect("cm:versionable") && overwrite)
            {
               ...
               // Call to AnalyticsService to record the document upload.
               analyticsService.record_UploadDocument(mimetype, existingFile.size, true);
      ...
      // Call to AnalyticsService to record the document upload.
      analyticsService.record_UploadDocument(mimetype, contentSize, updateNodeRef !== null);
   }
   catch (e)
   {
