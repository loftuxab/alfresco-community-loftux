	      ...
	      <td valign="middle" align="center">
	         ...
	         <#elseif isVideo>
	            <object width="320" height="240" border="0" id="${node.id}_player" classid="CLSID:6BF52A52-394A-11d3-B153-00C04F79FAA6">
	               ...
	               <embed type="application/x-mplayer2" pluginspage="http://microsoft.com/windows/mediaplayer/en/download/" src="${url.context}${node.url}?ticket=${sessionticket.ticket}" showcontrols="1" showdisplay="0" showstatusbar="0" autosize="1" autoplay="1" autoStart="1" height="240" width="320"></embed>
	            </object>
	         <#else>
