// This file is copied verbatim from the file of the same name in remote-api.
// We want to have exactly the same behaviour in Thor as for HEAD, but with additional analytics calls to record site creation.
// See line 100 below.
...
//   }
   ...
   //
   // Thor addition: record the site creation in our AnalyticsService.
   analyticsService.record_CreateSite(sitePreset, visibility)
   //
