...
import org.alfresco.repo.web.scripts.archive.ArchivedNodePut;
 ...
 */
public class NetworkAdminArchivedNodePut extends ArchivedNodePut
{
    ...
    protected Map<String, Object> executeImpl(final WebScriptRequest req, final Status status, final Cache cache)
    {
        return networkAdmin.runAs(new NetworkAdminRunAsWork<Map<String, Object>>()
        {
            ...
            {
                return NetworkAdminArchivedNodePut.super.executeImpl(req, status, cache);
            }
        });
    }
}
