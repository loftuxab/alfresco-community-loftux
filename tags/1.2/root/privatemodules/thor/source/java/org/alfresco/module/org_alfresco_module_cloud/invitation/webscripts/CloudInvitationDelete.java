...
/**
 * This class is the controller for the cloud-invitation.delete web script.
 * It cancels ongoing Cloud Invitation.
 * 
 * @author Neil Mc Erlean
 * @since Alfresco Cloud Module (Thor)
 */
public class CloudInvitationDelete extends AbstractCloudInvitationWebscript
{
    @Override
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache)
    {
        ...
        try
        {
            getCloudInvitationService().cancelInvitation(inviteId, key);
        }
