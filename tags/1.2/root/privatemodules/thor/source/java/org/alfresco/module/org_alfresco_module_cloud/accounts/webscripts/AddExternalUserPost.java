...
public class AddExternalUserPost extends DeclarativeWebScript
{
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache)
    {
        ...
        final String accountId = templateVars.get(ACCOUNT_ID);
        if (accountId == null || accountId.length() == 0)
        {
            throw new WebScriptException(Status.STATUS_NOT_FOUND, "Account not specified");
        }
        ...
        // add user to account
        registrationService.addUser(parseId(accountId), userId);
