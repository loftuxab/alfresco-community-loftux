...
public class HomeSiteSurfConfig implements ApplicationContextAware, InitializingBean
{
    ...
    public void afterPropertiesSet() throws Exception
    {
        ...
        {
            setConfigPath("alfresco/module/org_alfresco_module_cloud/bootstrap/homesite");
        }
    ...
    private String loadImportView() throws IOException
    {
        ...
        {
            throw new AlfrescoRuntimeException("Cannot find home site config " + importViewResource.getPath());
        }
