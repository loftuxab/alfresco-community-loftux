...
import org.alfresco.repo.web.scripts.archive.ArchivedNodesGet;
 ...
 */
public class NetworkAdminArchivedNodesGet extends ArchivedNodesGet
{
    ...
    protected Map<String, Object> executeImpl(final WebScriptRequest req, final Status status, final Cache cache)
    {
        return networkAdmin.runAs(new NetworkAdminRunAsWork<Map<String, Object>>()
        {
            ...
            {
                return NetworkAdminArchivedNodesGet.super.executeImpl(req, status, cache);
            }
        });
    }
}
