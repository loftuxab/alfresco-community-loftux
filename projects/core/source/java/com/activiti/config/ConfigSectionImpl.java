...
public class ConfigSectionImpl implements ConfigSection
{
   ...
   /**
    * @see com.activiti.config.ConfigSection#getEvaluator()
    */
   ...
   /**
    * @see com.activiti.config.ConfigSection#getCondition()
    */
   ...
   /**
    * @see com.activiti.config.ConfigSection#getConfigElements()
    */
   ...
   /**
    * @see com.activiti.config.ConfigSection#isGlobal()
    */
