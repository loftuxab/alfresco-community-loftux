...
public abstract class BaseConfigService implements ConfigService
{
   ...
   /**
    * @see com.activiti.config.ConfigService#destroy()
    */
   public void destroy()
   {
      this.sections.clear();
   ...
   /**
    * @see com.activiti.config.ConfigService#setConfigSource(com.activiti.config.ConfigSource)
    */
   ...
   /**
    * @see com.activiti.config.ConfigService#getConfig(java.lang.Object)
    */
   ...
   /**
    * @see com.activiti.config.ConfigService#getConfig(java.lang.Object, boolean)
    */
