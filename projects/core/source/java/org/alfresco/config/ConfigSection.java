...
public interface ConfigSection
{
    ...
    * section this object represents is applicable to the current lookup operation
    * 
   ...
   /**
    * Returns the condition to use to determine whether the config section this object
    * represents is applicable. The condition is passed to the evaluator
    * 
