<#-- Table of new docs in a specific folder -->
...
<table cellpadding=2>
   ...
   <#list space.children as child>
      <#if child.isDocument && ((dateCompare(child.properties["cm:modified"], date, 1000*60*60*24*7) == 1) || (dateCompare(child.properties["cm:created"], date, 1000*60*60*24*7) == 1))>
         <tr>
