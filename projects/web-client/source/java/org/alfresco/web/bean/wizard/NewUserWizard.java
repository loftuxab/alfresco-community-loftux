...
public class NewUserWizard extends AbstractWizardBean
{
    ...
    public String finish()
    {
        ...
        try
        {
            ...
            else
            {
                ...
                this.permissionService.setPermission(newPerson, this.userName, permissionService.getAllPermission(),
                        true);
        ...
        catch (Exception e)
        {
            ...
            Utils.addErrorMessage(MessageFormat.format(
                    Application.getMessage(FacesContext.getCurrentInstance(), ERROR), e.getMessage()), e);
            outcome = null;
        }
    ...
    private NodeRef getCompanyHomeSpace()
    {
        if (this.companyHomeSpaceRef == null)
        {
            ...
            String companyXPath = NamespaceService.APP_MODEL_PREFIX
                    + ":" + QName.createValidLocalName(companySpaceName);

            NodeRef rootNodeRef = this.nodeService.getRootNode(Repository.getStoreRef());
            List<NodeRef> nodes = this.searchService.selectNodes(rootNodeRef, companyXPath, null,
    ...
    private NodeRef createHomeSpace(String locationId, String spaceName, boolean error)
    {
        ...
        if (spaceName != null && spaceName.length() != 0)
        {
            ...
            ChildAssociationRef assocRef = this.nodeService.createNode(parentRef, ContentModel.ASSOC_CONTAINS, QName
                    .createQName(NamespaceService.SYSTEM_MODEL_1_0_URI, qname), ContentModel.TYPE_FOLDER);
            ...
            this.permissionService.setPermission(nodeRef, ContextListener.ADMIN, permissionService.getAllPermission(),
                    true);
            ...
            this.permissionService.setPermission(nodeRef, permissionService.getOwnerAuthority(), permissionService
                    .getAllPermission(), true);
