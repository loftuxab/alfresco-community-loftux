...
{
   /**
    * Override to support wrapping of a QNameMap by our custom wrapper object
    */
   ...
   /**
    * Inner class to support clone of QNameMap
    */
   class QNameHash extends SimpleHash
   {
      ...
      /**
       * Override to support clone of a QNameMap object
       */
