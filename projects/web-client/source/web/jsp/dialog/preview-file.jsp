                     ...
                     <table cellspacing="4" cellpadding="0" width="100%">
                        <tr valign="top">
                           ...
                           <td>
                              ...
                              <div class="mainTitle">
                                 <h:outputText value="#{msg.preview_of}" /> '<h:outputText value="#{DocumentPreviewBean.name}" />'<r:lockIcon value="#{DocumentPreviewBean.document.nodeRef}" align="absmiddle" />
                              </div>
                           ...
                           <td width=100>
                              ...
                              <a:actionLink value="#{msg.next_item}" image="/images/icons/NextItem.gif" padding="4" actionListener="#{DocumentPreviewBean.nextItem}" action="nextItem">
                                 <f:param name="id" value="#{DocumentPreviewBean.id}" />
                              </a:actionLink>
                              <a:actionLink value="#{msg.previous_item}" image="/images/icons/PreviousItem.gif" padding="4" actionListener="#{DocumentPreviewBean.previousItem}" action="previousItem">
                                 <f:param name="id" value="#{DocumentPreviewBean.id}" />
                              </a:actionLink>
                           </td>
                        </tr>
