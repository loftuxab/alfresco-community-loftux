                              ...
                              <table cellpadding="2" cellspacing="2" border="0" width="100%">
                                 ...
                                 <tr>
                                    <td style="padding:6px">
                                       ...
                                       <a class="title" href='<%=request.getContextPath()%><h:outputText value="#{CheckinCheckoutBean.workingDocument.properties.url}"/>'><h:outputText value="#{CheckinCheckoutBean.workingDocument.name}" /></a>
                                    </td>
                                 </tr>
                                 <tr>
                                    <td>
