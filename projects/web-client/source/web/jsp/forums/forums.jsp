            ...
            <table cellspacing=0 cellpadding=0 width=100%>
                        ...
                        <tr valign=top>
                           ...
                           <td width=110>
                              ...
                              <a:modeList itemSpacing="3" iconColumnWidth="20" selectedStyleClass="statusListHighlight" selectedImage="/images/icons/Details.gif"
                                    value="#{ForumsBean.forumsViewMode}" actionListener="#{ForumsBean.viewModeChanged}">
               ...
               <tr valign=top>
                  ...
                  <td>
                     ...
                     <%-- Forums List --%>
                     <a:richList id="forumsList" binding="#{ForumsBean.forumsRichList}" viewMode="#{ForumsBean.forumsViewMode}" pageSize="#{BrowseBean.browsePageSize}"
