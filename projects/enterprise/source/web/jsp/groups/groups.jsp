                        ...
                        <tr valign="top">
                           ...
                           <td width=110 style="padding-left:2px">
                              ...
                              <a:booleanEvaluator value="#{GroupsBean.currentGroup == null}">
                                 <a:actionLink value="#{msg.new_group}" image="/images/icons/create_group.gif" padding="4" action="newGroup" actionListener="#{GroupsBean.clearGroupAction}" />
                              </a:booleanEvaluator>
                              <a:booleanEvaluator value="#{GroupsBean.currentGroup != null}">
                                 <a:actionLink value="#{msg.new_sub_group}" image="/images/icons/create_group.gif" padding="4" action="newGroup" actionListener="#{GroupsBean.setupGroupAction}">
                                    <f:param name="id" value="#{GroupsBean.currentGroup}" />
                                 </a:actionLink>
                                 <a:actionLink value="#{msg.delete_group}" image="/images/icons/delete_group.gif" padding="4" action="deleteGroup" actionListener="#{GroupsBean.setupGroupAction}">
                                    <f:param name="id" value="#{GroupsBean.currentGroup}" />
                                 </a:actionLink>
                                 <%-- TODO: should this be add user(S) - multiple required on generic picker? --%>
                                 <a:actionLink value="#{msg.add_user}" image="/images/icons/add_user.gif" padding="4" action="addUser" actionListener="#{GroupsBean.setupGroupAction}">
                                    <f:param name="id" value="#{GroupsBean.currentGroup}" />
                                 </a:actionLink>
                              </a:booleanEvaluator>
                           </td>
                           ...
                           <td width=100 style="padding-left:2px">
                              ...
                              <h:outputText style="padding-left:26px" styleClass="mainSubTitle" value="#{msg.filter}"/><br>
                              <a:modeList itemSpacing="3" iconColumnWidth="20" selectedStyleClass="statusListHighlight" selectedImage="/images/icons/Details.gif"
                                    value="#{GroupsBean.filterMode}" actionListener="#{GroupsBean.filterModeChanged}">
                           ...
                           <td width=100 style="padding-left:2px">
                              ...
                              <a:modeList itemSpacing="3" iconColumnWidth="20" selectedStyleClass="statusListHighlight" selectedImage="/images/icons/Details.gif"
                                    value="#{GroupsBean.viewMode}" actionListener="#{GroupsBean.viewModeChanged}">
