...
/**
 * Created by P3700481 on 12/8/2014.
 */
public class WcmqsNewsPageTest extends AbstractUtils
{
        ...
        public void dataPrep_NewsPageTest() throws Exception
        {
                // User login
                // ---- Step 1 ----
                // ---- Step Action -----
        ...
        public void testGetNewsDescrition(){
                ...
                WcmqsNewsPage newsPage = new WcmqsNewsPage(drone);
                Assert.assertEquals(newsPage.getNewsDescrition(newsName), "Ubique ancillae appellantur cu per, possit perpe tua repudiare vix cu, eius inciderint scribentur ut eos. Nam an deleniti placerat petentium.");
        }
        ...
        public void testGetHeadlineTitleNews(){
                WcmqsNewsPage newsPage = new WcmqsNewsPage(drone);
                Assert.assertEquals(newsPage.getHeadlineTitleNews().size(), 6, "The number of headline titles in the news Page is " + newsPage.getHeadlineTitleNews().size() + ". Expected 6 but was " + newsPage.getHeadlineTitleNews().size() + ".");
        }
        ...
        public void testClickNewsByName(){
                ...
                Assert.assertTrue(pageTitle.contains("Global"));
        }

        @Test
        public void testClickNewsByTitle(){
