...
public class ResultSet  implements java.io.Serializable {
    private org.alfresco.repo.webservice.types.ResultSetRow[] row;
    private long size;
    ...
    public ResultSet(
           org.alfresco.repo.webservice.types.ResultSetRow[] row,
           long size,
     ...
     * @return row
     */
    public org.alfresco.repo.webservice.types.ResultSetRow[] getRow() {
        return row;
    }
     ...
     * @param row
     */
    public void setRow(org.alfresco.repo.webservice.types.ResultSetRow[] row) {
        this.row = row;
    }

    public org.alfresco.repo.webservice.types.ResultSetRow getRow(int i) {
        return this.row[i];
    }

    public void setRow(int i, org.alfresco.repo.webservice.types.ResultSetRow _value) {
        this.row[i] = _value;
    }
