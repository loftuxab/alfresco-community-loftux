...
public class LockType  implements java.io.Serializable {
    private org.alfresco.repo.webservice.authoring.LockTypeEnum type;

    public LockType() {
    }

    public LockType(
           org.alfresco.repo.webservice.authoring.LockTypeEnum type) {
           this.type = type;
    }
     ...
     * @return type
     */
    public org.alfresco.repo.webservice.authoring.LockTypeEnum getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(org.alfresco.repo.webservice.authoring.LockTypeEnum type) {
        this.type = type;
    }
