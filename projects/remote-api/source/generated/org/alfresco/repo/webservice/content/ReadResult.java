...
public class ReadResult  implements java.io.Serializable {
    ...
    private org.alfresco.repo.webservice.types.Content content;
    ...
    public ReadResult(
           ...
           byte[] stream,
           long bytesRead,
           org.alfresco.repo.webservice.types.Content content) {
     ...
     * @return content
     */
    public org.alfresco.repo.webservice.types.Content getContent() {
        return content;
    }
     ...
     * @param content
     */
    public void setContent(org.alfresco.repo.webservice.types.Content content) {
        this.content = content;
    }
