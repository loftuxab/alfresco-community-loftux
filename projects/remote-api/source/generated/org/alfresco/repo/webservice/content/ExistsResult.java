...
public class ExistsResult  implements java.io.Serializable {
    private org.alfresco.repo.webservice.types.Reference content;
    ...
    public ExistsResult(
           org.alfresco.repo.webservice.types.Reference content,
           boolean exists,
           long length) {
     ...
     * @return content
     */
    public org.alfresco.repo.webservice.types.Reference getContent() {
        return content;
    }
     ...
     * @param content
     */
    public void setContent(org.alfresco.repo.webservice.types.Reference content) {
        this.content = content;
    }
