...
public class StoreRedirectorProxyFactoryTest extends TestCase
{
    ...
    public void testInvalidArgs()
    {
        ...
        try
        {
            ...
            fail("Failed to catch invalid store type" + storeRef1.getProtocol());
        }
        catch(ServiceException e) {}
        
        try
        {
            String result1 = service.nodeRef(nodeRef1);
            fail("Failed to catch invalid store type" + nodeRef1.getStoreRef().getProtocol());
        }
        catch(ServiceException e) {}
    }
