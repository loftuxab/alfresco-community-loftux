...
public abstract class AbstractNodeServiceImpl implements NodeService
{
    ...
    /**
     * @see NodeServicePolicies.BeforeCreateAssociationPolicy#beforeCreateAssociation(NodeRef,
     *      NodeRef, QName)
     */
    protected void invokeBeforeCreateAssociation(NodeRef sourceNodeRef, NodeRef targetNodeRef, QName assocTypeQName)
    {
        // get qnames to invoke against
        Set<QName> qnames = getTypeAndAspectQNames(sourceNodeRef);
        // execute policy for node type and aspects
        NodeServicePolicies.BeforeCreateAssociationPolicy policy = beforeCreateAssociationDelegate.get(qnames, assocTypeQName);
    ...
    protected void invokeBeforeDeleteAssociation(AssociationRef nodeAssocRef)
    {
        ...
        Set<QName> qnames = getTypeAndAspectQNames(sourceNodeRef);
        // execute policy for node type and aspects
        NodeServicePolicies.BeforeDeleteAssociationPolicy policy = beforeDeleteAssociationDelegate.get(qnames, assocTypeQName);
