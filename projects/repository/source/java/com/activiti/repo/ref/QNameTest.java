...
public class QNameTest extends TestCase
{
    ...
    public void testPrefix()
    {
        try
        {
            QName noResolver = QName.createQName(NamespaceService.ACTIVITI_PREFIX, "activiti prefix", null);
        ...
        QName qname1 = QName.createQName(NamespaceService.ACTIVITI_PREFIX, "activiti prefix", mockResolver);
        assertEquals(NamespaceService.ACTIVITI_URI, qname1.getNamespaceURI());
        ...
        implements NamespacePrefixResolver
    {
        ...
        public String getNamespaceURI(String prefix)
        {
            ...
            else if (prefix.equals(NamespaceService.ACTIVITI_PREFIX))
            {
                return NamespaceService.ACTIVITI_URI;
            }
