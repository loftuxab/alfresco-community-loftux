...
{
   /**
    * Create an index entry when a new node is created. A node is always created
    * with a name in a given parent and so a relationship ref is required.
    * 
    ...
    * refernces to the node from the index. The index has no idea of the primary
    * link.
    * 
    * @param relationshipRef
    */
    ...
    * </OL>
    * 
    * This could be implemented as a delete and add but some implementations may
    * be able to optimise this operation.
    * 
