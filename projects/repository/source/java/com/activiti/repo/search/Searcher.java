...
/**
 * Ths encapsultes the execution of search against different indexing mechanisms.
 * 
...
{  
    ...
    * @param queryOptions - explicit list of properties to extract for the selected nodes.
    * @param queryParameter - string name, string value pairs with an optional type hint 
    * @return
    */
