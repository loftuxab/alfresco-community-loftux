...
public class FullTextSearchIndexerImpl implements FTSIndexerAware, FullTextSearchIndexer
{
     ...
     * (non-Javadoc)
     * 
     * @see com.activiti.repo.search.impl.lucene.fts.FullTextSearchIndexer#requiresIndex(com.activiti.repo.ref.StoreRef)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.activiti.repo.search.impl.lucene.fts.FullTextSearchIndexer#indexCompleted(com.activiti.repo.ref.StoreRef,
     ...
     * (non-Javadoc)
     * 
     * @see com.activiti.repo.search.impl.lucene.fts.FullTextSearchIndexer#pause()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.activiti.repo.search.impl.lucene.fts.FullTextSearchIndexer#resume()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.activiti.repo.search.impl.lucene.fts.FullTextSearchIndexer#index()
     */
    public void index()
    {
