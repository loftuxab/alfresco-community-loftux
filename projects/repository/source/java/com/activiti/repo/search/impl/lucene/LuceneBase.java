...
public abstract class LuceneBase
{
   ...
   /**
    * The writer for the delta to disk. (This should no coexist with the reader)
    */
   ...
   protected void initialise(StoreRef store, String deltaId) throws IOException
   {
      ...
      if (deltaId != null)
      {
         ...
         undoDir = initialiseFSDirectory(
               basePath + File.separator + "undo" + File.separator + deltaId + File.separator, true);
   ...
   /**
    * Utility method to initiliase a lucene FSDirectorya at a given location. We
    * may try and delete the directory when the JVM exits.
    * 
    * @param path
    * @param temp
    * @return
    ...
    * 
    * @param terms
    *           A list of terms that identifiy documents to be deleted from the
    *           main index before the delta os merged in.
    * 
    * @throws IOException
    */
    ...
    * 
    * This tries to tidy up all it can. It is possible some stuff will remain if
    * errors are throws else where
    * 
