...
public class MSExcelTest extends AbstractUtils
{
        ...
        public void AONE_9829() throws Exception
        {
                ...
                Assert.assertTrue(excelName.contains(xlsFileName_9829) && excelName.contains("Excel"), "File was not found");
        ...
        public void AONE_9830() throws Exception
        {
                ...
                Assert.assertTrue(excelName.contains(xlsFileName_9830) && excelName.contains("Excel"), "File was not found");
        ...
        public void AONE_9831() throws Exception
        {
                ...
                excel.operateOnOpen(l, sharepointPath, siteName, xlsFileName_9831 + fileType, testUser, DEFAULT_PASSWORD);

                // Workbook is opened in MS Office Excel 2013;

                String excelName = excel.getAbstractUtil().findWindowName(xlsFileName_9831);
                Assert.assertTrue(excelName.contains(xlsFileName_9831) && excelName.contains("Excel"), "File was not found");
                ...
                Assert.assertTrue(documentContent.contains(testName), "Changes are not present in the document.");
        ...
        public void AONE_9832() throws Exception
        {
                ...
                // open;
                // 4. Click Open button;
                excel.operateOnOpen(l, sharepointPath, siteName, xlsFileName_9832 + fileType, testUser, DEFAULT_PASSWORD);
                ...
                Assert.assertTrue(excelName.contains(xlsFileName_9832) && excelName.contains("Excel"), "File was not found");
        ...
        public void AONE_9833() throws Exception
        {
                ...
                // open;
                // Click Open button;
                excel.operateOnOpen(l, sharepointPath, siteName, xlsFileName_9833 + fileType, testUser, DEFAULT_PASSWORD);
                ...
                // Workbook is opened in MS Office Excel 2013;
                Assert.assertTrue(excelName.contains(xlsFileName_9833) && excelName.contains("Excel"), "File was not found");
        ...
        public void AONE_9834() throws Exception
        {
                ...
                // open;
                // 4. Click Open button;
                excel.operateOnOpen(l, sharepointPath, siteName, xlsFileName_9834 + fileType, testUser, DEFAULT_PASSWORD);
        ...
        public void AONE_9835() throws Exception
        {
                ...
                // open;
                // Click Open button;
                excel.operateOnOpen(l, sharepointPath, siteName, xlsFileName_9835 + fileType, testUser, DEFAULT_PASSWORD);

                String excelName = excel.getAbstractUtil().findWindowName(xlsFileName_9835);
                // the window name contains "frm" string at the begining
                // Workbook is opened in MS Office Excel 2013;
                Assert.assertTrue(excelName.contains(xlsFileName_9835) && excelName.contains("Excel"), "File was not found");
                ...
                String newData = "new input data";
                excel.editOffice(l1, newData);
                l1.verifySetText("pane8", newData);
                // Save the document
                // excel.goToFile(l2);
                ...
                String actualName2 = excel.getAbstractUtil().findWindowName(xlsFileName_9835);
                ...
                String documentContent = detailsPage.getDocumentBody();
                Assert.assertTrue(documentContent.contains(newData), "Changes are not present in the document.");
        ...
        public void AONE_9836() throws Exception
        {
                ...
                excel.operateOnOpen(l, sharepointPath, siteName, xlsFileName_9836 + fileType, testUser, DEFAULT_PASSWORD);

                String excelName = excel.getAbstractUtil().findWindowName(xlsFileName_9836);
                // the window name contains "frm" string at the begining
                // Workbook is opened in MS Office Excel 2013;
                Assert.assertTrue(excelName.contains(xlsFileName_9836) && excelName.contains("Excel"), "File was not found");
        ...
        public void AONE_9837() throws Exception
        {
                ...
                excel.operateOnOpen(l, sharepointPath, siteName, xlsFileName_9837 + fileType, testUser, DEFAULT_PASSWORD);

                String excelName = excel.getAbstractUtil().findWindowName(xlsFileName_9837);
                Assert.assertTrue(excelName.contains(xlsFileName_9837) && excelName.contains("Excel"), "File was not found");
                ;
        ...
        public void AONE_9838() throws Exception
        {
                ...
                // open;
                // Click Open button;
                excel.operateOnOpen(l, sharepointPath, siteName, xlsFileName_9838 + fileType, testUser, DEFAULT_PASSWORD);

                String excelName = excel.getAbstractUtil().findWindowName(xlsFileName_9838);
                // Workbook is opened in MS Office Excel 2013;
                Assert.assertTrue(excelName.contains(xlsFileName_9838) && excelName.contains("Excel"), "File was not found");
        ...
        public void AONE_9839() throws Exception
        {
                ...
                excel.operateOnOpen(l, sharepointPath, siteName, xlsFileName_9839 + fileType, testUser, DEFAULT_PASSWORD);

                String excelName = excel.getAbstractUtil().findWindowName(xlsFileName_9839);

                // Workbook is opened in MS Office Excel 2013;
                Assert.assertTrue(excelName.contains(xlsFileName_9839) && excelName.contains("Excel"), "File was not found");
                ...
                String actualName2 = excel.getAbstractUtil().findWindowName(xlsFileName_9839);
                Assert.assertTrue(actualName2.contains("[Read-Only]"), "Word is NOT opened in read only mode");
                ...
                String documentContent = detailsPage.getDocumentBody();
                Assert.assertTrue(documentContent.contains(newContent), "Changes are not applied to the document.");
        ...
        public void AONE_9840() throws Exception
        {
                ...
                excel.operateOnOpen(l, sharepointPath, siteName, xlsFileName_9840 + fileType, testUser, DEFAULT_PASSWORD);

                String excelName = excel.getAbstractUtil().findWindowName(xlsFileName_9840);

                // Workbook is opened in MS Office Excel 2013;
                Assert.assertTrue(excelName.contains(xlsFileName_9840) && excelName.contains("Excel"), "File was not found");
        ...
        public void AONE_9841() throws Exception
        {
                ...
                excel.operateOnOpen(l, sharepointPath, siteName, xlsFileName_9841 + fileType, testUser, DEFAULT_PASSWORD);

                String excelName = excel.getAbstractUtil().findWindowName(xlsFileName_9841);

                // Workbook is opened in MS Office Excel 2013;
                Assert.assertTrue(excelName.contains(xlsFileName_9841) && excelName.contains("Excel"), "File was not found");
