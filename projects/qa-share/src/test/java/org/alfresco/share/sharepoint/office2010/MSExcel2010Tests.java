...
public class MSExcel2010Tests extends AbstractUtils
{
        ...
        public void AONE_9666() throws Exception
        {
                ...
                DocumentDetailsPage detailsPage = documentLibPage.selectFile(xlsFileName_9666 + fileType).render();
        ...
        public void AONE_9668() throws Exception
        {
                ...
                Assert.assertTrue(
                        ShareUserSitePage.getDocTreeMenuWithRetry(drone, xlsFileName_9668 + fileType, TreeMenuNavigation.DocumentsMenu.IM_EDITING, true),
                        xlsFileName_9668 + fileType + " cannot be found.");
        ...
        public void AONE_9669() throws Exception
        {
                ...
                treeMenuNavigation.selectDocumentNode(TreeMenuNavigation.DocumentsMenu.IM_EDITING).render();
                Assert.assertTrue(
                        ShareUserSitePage.getDocTreeMenuWithRetry(drone, xlsFileName_9669 + fileType, TreeMenuNavigation.DocumentsMenu.IM_EDITING, true),
                        xlsFileName_9669 + fileType + " cannot be found.");
        ...
        public void AONE_9670() throws Exception
        {
                ...
                excel.editOffice(l2, newData);
                l2.verifySetText("pane8", newData);
