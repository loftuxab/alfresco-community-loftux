...
public class ShareRefreshMoveToSites extends AbstractUtils
{
    ...
    public void AONE_14029() throws Exception
    {
        ...
        docPage = ShareUser.copyOrMoveArtifact(drone, "Recent Sites", recentSiteName, sampleFile.getName(), PerformOperation.OK, TypeOfPage.MoveTo).render();
    ...
    public void AONE_14031() throws Exception
    {
        ...
        docPage = ShareUser.copyOrMoveArtifact(drone, "Favorite Sites", favouriteSiteName, sampleFile.getName(), PerformOperation.OK, TypeOfPage.MoveTo)
                .render();
    ...
    public void AONE_14032() throws Exception
    {
        ...
        docPage = ShareUser.copyOrMoveArtifact(drone, "Favorite Sites", favouriteSiteName, sampleFile.getName(), PerformOperation.CANCEL, TypeOfPage.MoveTo)
                .render();
    ...
    public void AONE_14033() throws Exception
    {
        ...
        docPage = ShareUser.copyOrMoveArtifact(drone, "All Sites", anySiteName, sampleFile.getName(), PerformOperation.OK, TypeOfPage.MoveTo).render();
