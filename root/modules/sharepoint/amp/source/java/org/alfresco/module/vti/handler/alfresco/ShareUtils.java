...
public class ShareUtils
{
    ...
    /**
     * 
     * @param shareHostWithPort shareHostWithPort to set
     */
    ...
    {
        PostMethod loginMethod = new PostMethod(SCHEME_PREFIX + shareHostWithPort + shareContext + shareLoginUri);     
        
        loginMethod.setRequestHeader(HEADER_REFERER, SCHEME_PREFIX + shareHostWithPort + shareContext + shareWelcomeUri);
        ...
        NameValuePair[] parametres = new NameValuePair[]{new NameValuePair("username", login), new NameValuePair("password", password), new NameValuePair("success", "/share/page/site-index"), new NameValuePair("failure", "/share/page?f=default&pt=login&error=true")};
    ...
    {
        GetMethod siteDashboardMethod = new GetMethod(SCHEME_PREFIX + shareHostWithPort + shareContext + shareSiteDashboardUri.replace("...", siteShortName));
     ...
     * @throws IOException
     */
    public void createSite(String login, String password, String sitePreset, String shortName, String title, String description, boolean isPublic) throws HttpException, IOException
    {
        HttpClient httpClient = new HttpClient();
        PostMethod createSiteMethod = new PostMethod(SCHEME_PREFIX + shareHostWithPort + shareContext + shareCreateSiteUri);       
    ...
    {
        HttpClient httpClient = new HttpClient();
        PostMethod deleteSiteMethod = new PostMethod(SCHEME_PREFIX + shareHostWithPort + shareContext + shareDeleteSiteUri);       
