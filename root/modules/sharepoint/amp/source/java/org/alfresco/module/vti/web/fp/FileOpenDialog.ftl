...
<BODY topmargin=5 leftmargin=5 scroll=no serverType=OWS onload="checkScroll()" onresize="checkScroll()">
   ...
   <table ID="FileDialogViewTable" width="100%" class="recordSet" style="cursor: default;" cellspacing=0>
	<tr>
		<th style="padding: 2px; text-align: left" class="recordSetHeader"><a class="header" ID="diidSortDocIcon" TITLE="Sort by Type" SORTINGFIELDS="RootFolder=${location}&SortField=DocIcon&SortDir=${DialogUtils.getSortDir("DocIcon", sortField, sort)}&View=FileDialog" onmouseover="changeStyle('diidSortDocIcon');" onmouseout="revertStyle('diidSortDocIcon');">
        ...
        <th style="padding: 2px; text-align: left" class="recordSetHeader"><a class="header" ID="diidSortBaseName" TITLE="Sort by Name" SORTINGFIELDS="RootFolder=${location}&SortField=BaseName&SortDir=${DialogUtils.getSortDir("BaseName", sortField, sort)}&View=FileDialog" onmouseover="changeStyle('diidSortBaseName');" onmouseout="revertStyle('diidSortBaseName');">
        ...
        <th style="padding: 2px; text-align: left" class="recordSetHeader"><a class="header" ID="diidSortEditor" TITLE="Sort by Modified By" SORTINGFIELDS="RootFolder=${location}&SortField=Editor&SortDir=${DialogUtils.getSortDir("Editor", sortField, sort)}&View=FileDialog" onmouseover="changeStyle('diidSortEditor');" onmouseout="revertStyle('diidSortEditor');">
         Modified By <#if sortField.equals(DialogUtils.getSortFieldValue("Editor"))><img src='${alfContext}/resources/images/icons/<#if sort.equals(DialogUtils.getSortValue("Asc"))>sort_up.gif<#else>sort_down.gif</#if>' width='10' height='6' alt='' style='border-width:0px;'/> </#if></a></th>   
		<th style="padding: 2px; text-align: left" class="recordSetHeader"><a class="header" ID="diidSortLast_x0020_Modified" TITLE="Sort by Modified" SORTINGFIELDS="RootFolder=${location}&SortField=Last_x0020_Modified&SortDir=${DialogUtils.getSortDir("Last_x0020_Modified", sortField, sort)}&View=FileDialog" onmouseover="changeStyle('diidSortLast_x0020_Modified');" onmouseout="revertStyle('diidSortLast_x0020_Modified');">
        ...
        <th style="padding: 2px; text-align: left" class="recordSetHeader"><a class="header" ID="diidSortCheckedOutTitle" TITLE="Sort by Checked Out To" SORTINGFIELDS="RootFolder=${location}&SortField=CheckedOutTitle&SortDir=${DialogUtils.getSortDir("CheckedOutTitle", sortField, sort)}&View=FileDialog" onmouseover="changeStyle('diidSortCheckedOutTitle');" onmouseout="revertStyle('diidSortCheckedOutTitle');">
         Checked Out To <#if sortField.equals(DialogUtils.getSortFieldValue("CheckedOutTitle"))><img src='${alfContext}/resources/images/icons/<#if sort.equals(DialogUtils.getSortValue("Asc"))>sort_up.gif<#else>sort_down.gif</#if>' width='10' height='6' alt='' style='border-width:0px;'/> </#if></a></th>
	</tr>
