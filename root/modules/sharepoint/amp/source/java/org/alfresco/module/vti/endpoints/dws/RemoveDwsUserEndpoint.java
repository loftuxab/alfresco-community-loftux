...
public class RemoveDwsUserEndpoint extends VtiEndpoint
{
    ...
    protected Element invokeInternal(Element element, Document document) throws Exception
    {
        ...
        XPath idPath = new Dom4jXPath(EndpointUtils.buildXPath(prefix, "/RemoveDwsUser/id"));
        idPath.setNamespaceContext(nc);
        Element id = (Element) idPath.selectSingleNode(element);

        // creating soap response
        Element root = document.addElement("RemoveDwsUserResponse", namespace);
        ...
        handler.removeDwsUser(dws, id.getText());
