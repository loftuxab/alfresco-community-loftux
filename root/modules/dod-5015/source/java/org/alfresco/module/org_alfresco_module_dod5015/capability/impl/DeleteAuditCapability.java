...
public class DeleteAuditCapability extends AbstractCapability
{
    ...
    public DeleteAuditCapability(RMEntryVoter voter)
    {
        super(voter);
    }
    ...
    public int evaluate(NodeRef nodeRef)
    {
        if (isRm(nodeRef))
        {
            if (voter.getPermissionService().hasPermission(nodeRef, RMPermissionModel.DELETE_AUDIT) == AccessStatus.ALLOWED)
            {
