...
public class CreateModifyDestroyFileplanTypesCapability extends AbstractCapability
{
    ...
    public CreateModifyDestroyFileplanTypesCapability(RMEntryVoter voter)
    {
        super(voter);
    }
    ...
    public int evaluate(NodeRef nodeRef)
    {
        if (isRm(nodeRef))
        {
            if (voter.getPermissionService().hasPermission(nodeRef, RMPermissionModel.CREATE_MODIFY_DESTROY_FILEPLAN_TYPES) == AccessStatus.ALLOWED)
            {
