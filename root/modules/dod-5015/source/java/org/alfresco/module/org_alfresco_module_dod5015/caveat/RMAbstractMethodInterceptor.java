...
/**
 * RM abstract method interceptor to veto 'access' based on RM caveat config
 * 
 * @author janv
 */
public abstract class RMAbstractMethodInterceptor implements MethodInterceptor
{
    protected static final String MSG_ACCESS_DENIED = "permissions.err_access_denied";
