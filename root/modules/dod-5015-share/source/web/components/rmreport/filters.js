...
(function()
{
    ...
    * @return {Alfresco.ReportFilter} The new ReportFilter instance
    * @constructor
    */
   Alfresco.ReportFilter = function(htmlId)
   {
      this.name = "Alfresco.ReportFilter";
      this.id = htmlId;
   ...
   Alfresco.ReportFilter.prototype =
   {
      /**
       * Selected filter.
       * 
       ...
       */
      onComponentsLoaded: function ReportFilter_onComponentsLoaded()
      {
       ...
       * @method onReady
       */
      onReady: function ReportFilter_onReady()
      {
         var me = this;
         
         YAHOO.Bubbling.addDefaultAction("filter-link", function ReportFilter_filterAction(layer, args)
         {
       ...
       */
      onDeactivateAllControls: function ReportFilter_onDeactivateAllControls(layer, args)
      {
