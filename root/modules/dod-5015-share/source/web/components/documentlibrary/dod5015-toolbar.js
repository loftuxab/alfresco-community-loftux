...
(function()
{
   ...
   Alfresco.RecordsDocListToolbar = function(htmlId)
   {
      ...
      this.name = "Alfresco.RecordsDocListToolbar";
      this.id = htmlId;
   ...
   Alfresco.RecordsDocListToolbar.prototype =
   {
      /**
       ...
       * @return {Alfresco.RecordsDocListToolbar} returns 'this' for method chaining
       */
      ...
      {
         return Alfresco.util.message.call(this, messageId, "Alfresco.RecordsDocListToolbar", Array.prototype.slice.call(arguments).slice(1));
      }
   };
})();