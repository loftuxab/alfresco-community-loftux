...
<!-- Save Search -->
<@link rel="stylesheet" type="text/css" href="${page.url.context}/modules/rmsearch/save-search.css" />
<@script type="text/javascript" src="${page.url.context}/modules/rmsearch/save-search.js"></@script>