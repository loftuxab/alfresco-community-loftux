 ...
 */
public class RenditionBootstrap implements ApplicationContextAware, 
										   ...
										   WebSiteModel
{
	 ...
	 * @param definitions	list of bootstrap rendition definitions
	 */
	...
	private RenditionDefinition getRenditionDefinition(BootstrapRenditionDefinition definition)
	{
		...
		RenderingEngineDefinition engine = renditionService.getRenderingEngineDefinition(definition.getRenderingEngineName());
		if (engine == null)
		{
		...
		{
			renDef = renditionService.createRenditionDefinition(definition.getQName(), definition.getRenderingEngineName());
		}
