...
public class WebassetCollectionFolderType implements WebSiteModel
{
	...
	{	
		policyComponent.bindAssociationBehaviour(
	                ...
	                WebSiteModel.TYPE_WEBASSET_COLLECTION_FOLDER, 
	                ContentModel.ASSOC_CONTAINS,
	                new JavaBehaviour(this, "onCreateChildAssociationEveryEvent", NotificationFrequency.EVERY_EVENT));
	}
	
	/**
	 * Down-casts any folders created in a the collection folder to be webasset collections.
	 * 
	...
	public void onCreateChildAssociationEveryEvent(ChildAssociationRef childAssoc, boolean isNewNode) 
	{
		...
		if (nodeService.exists(nodeRef) == true)
		{
			...
			if (dictionaryService.isSubClass(createdNodeType, ContentModel.TYPE_FOLDER) == true)
			{
				...
				permissionService.setPermission(nodeRef, PermissionService.ALL_AUTHORITIES, PermissionService.CREATE_CHILDREN, false);
			}
		}					
	}
}
