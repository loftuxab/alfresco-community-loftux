           ...
           <div class="tabcontent">
             ...
             <ul id="Content" class="e2e list active">
                ...
                <li class="details ${content.type}">
                 <p class="toenail"><a href="/share/proxy/alfresco-feed/${content.browseUrl}"><img src="${url.context}/themes/${theme}/images/icons/${content.displayType}.png" /></a></p>                 
                 <h3><a href="/share/proxy/alfresco-feed/${content.browseUrl}">${content.displayName}</a></h3>
                 <p><span>${msg('Modified by')}:</span> ${content.modifiedBy}</p>
                 <p><span>${msg('Modified on')}:</span> ${content.modifiedOn?string("dd MMM yyyy HH:mm")}</p>
                 <p><span>${msg('Size')}:</span> ${content.size}</p>
               ...
               <li class="details">
                  <#if (person.avatar??)>
                    <p class="toenail"><a href="${url.context}/p/profile?person=${person.userName}"><img src="/share/proxy/alfresco/${person.avatar}"/></a></p>                                                     
                  <#else>
