...
public class CmisNavigationServiceClient extends AbstractServiceClient
{
    ...
    public void initialize() throws Exception
    {
        ...
        documentId = createAndAssertDocument(System.currentTimeMillis() + TEST_FILE_NAME, getAndAssertDocumentTypeId(), folderId, null, EnumVersioningState.major);
    ...
    public void invoke() throws Exception
    {
        ...
        navigationServicePort.getDescendants(new GetDescendants(getAndAssertRepositoryId(), getAndAssertRootFolderId(),
                BigInteger.valueOf(2), "*", Boolean.FALSE, EnumIncludeRelationships.both, Boolean.FALSE, null));
    ...
    public void testFoldersTreeReceiving() throws Exception
    {
        ...
        assertNotNull(foldersTreeResponse);
    ...
    public void testFilteredFoldersTreeReceiving() throws Exception
    {
        ...
        for (CmisObjectType object : foldersTreeResponse)
        {
            ...
            assertNotNull(properties.getPropertyDateTime());
            assertNotNull(properties.getPropertyString());

            assertEquals(1, properties.getPropertyId().length);
            assertEquals(1, properties.getPropertyDateTime().length);
    ...
    public void testDescendantsReceiving() throws Exception
    {
        ...
        NavigationServicePortBindingStub navigationService = getServicesFactory().getNavigationService();
        CmisObjectType[] descendantsResponse = navigationService.getDescendants(new GetDescendants(getAndAssertRepositoryId(), folderId, 
                BigInteger.valueOf(-1), "*", false, EnumIncludeRelationships.none, false, null));

        assertNotNull(descendantsResponse);
    ...
    public void testDescendantsResponseFoldersLeading() throws Exception
    {
        ...
        NavigationServicePortBindingStub navigationService = getServicesFactory().getNavigationService();
        CmisObjectType[] descendantsResponse = navigationService.getDescendants(new GetDescendants(getAndAssertRepositoryId(), folderId,
                BigInteger.valueOf(TEST_TREE_DEPTH), "*", false, EnumIncludeRelationships.none, false, null));
    ...
    public void testDepthLimitedDescendantsReceiving() throws Exception
    {
        ...
        NavigationServicePortBindingStub navigationService = getServicesFactory().getNavigationService();
        CmisObjectType[] descendantsResponse = navigationService.getDescendants(new GetDescendants(getAndAssertRepositoryId(), folderId, 
                BigInteger.valueOf(2), "*", false, EnumIncludeRelationships.none, false, null));
    ...
    public void testFilteredDescendantsReceiving() throws Exception
    {
        ...
        String filter = PROP_NAME + ", " + PROP_OBJECT_ID + ", " + PROP_CREATION_DATE;
        CmisObjectType[] descendantsResponse = navigationService.getDescendants(new GetDescendants(getAndAssertRepositoryId(), folderId,
                BigInteger.valueOf(3), filter, false, EnumIncludeRelationships.none, false, null));
        assertNotNull(descendantsResponse);
    ...
    public void testChildrenReceiving() throws Exception
    {
        ...
        GetChildrenResponse childrenResponse = navigationService.getChildren(new GetChildren(getAndAssertRepositoryId(), folderId, "*", false,
                EnumIncludeRelationships.none,  false, false, BigInteger.valueOf(0), BigInteger.valueOf(0), null));
    ...
    public void testGetChildrenPaigingFunctionality() throws Exception
    {
        ...
        do
        {
            childrenResponse = navigationService.getChildren(new GetChildren(getAndAssertRepositoryId(), folderId, "*", false,
                    EnumIncludeRelationships.none, false, false, BigInteger.valueOf(PAGING_STEP), BigInteger.valueOf(skipCount - PAGING_STEP), null));
            ...
            assertTrue((skipCount < expectedObjects.size()) ? (childrenResponse.isHasMoreItems()) : (!childrenResponse.isHasMoreItems()));
    ...
    {
        String folderName = TEST_FOLDER_NAME + System.currentTimeMillis();
        String childFolder = createAndAssertFolder(folderName, getAndAssertFolderTypeId(), folderId);
    ...
    public void testRelationshipsAndAllowableActionsReceiving() throws Exception
    {
        ...
        GetChildrenResponse childrenResponse = navigationService.getChildren(new GetChildren(getAndAssertRepositoryId(), folderId, "*", true,
                EnumIncludeRelationships.both, false, false, BigInteger.valueOf(0), BigInteger.valueOf(0), null));
        CmisObjectType[] descendantsResponse = navigationService.getDescendants(new GetDescendants(getAndAssertRepositoryId(), folderId,
                BigInteger.valueOf(1), "*", true, EnumIncludeRelationships.both, false, null));
        ...
        for (CmisObjectType object : objects)
        {
            ...
            for (CmisObjectType relationshipObject : object.getRelationship())
            {
                ...
                String sourceObjectId = getAndAssertIdPropertyValue(relationshipObject.getProperties(), PROP_SOURCE_OBJECT_ID);
                String targetObjectId = getAndAssertIdPropertyValue(relationshipObject.getProperties(), PROP_TARGET_OBJECT_ID);

                assertTrue("Object response has no any connection with its Relationship Object (it is not Target or Source Object)", id
    ...
    public void testFilteringWithWrongFilter() throws Exception
    {
        ...
        try
        {
            navigationService.getChildren(new GetChildren(getAndAssertRepositoryId(), folderId, INVALID_FILTER, false,
                    EnumIncludeRelationships.none, false, false, BigInteger.valueOf(0), BigInteger.valueOf(0), null));
        ...
        try
        {
            navigationService.getDescendants(new GetDescendants(getAndAssertRepositoryId(), folderId, BigInteger.valueOf(-1), INVALID_FILTER,
...
//        }
    ...
    public void testGetCheckedoutDocsFolder() throws Exception
    {
        ...
        {
            GetCheckedOutDocsResponse response = null;
            String document1Id = createAndAssertDocument(System.currentTimeMillis() + TEST_FILE_NAME, getAndAssertDocumentTypeId(), getAndAssertRootFolderId(), null,
            ...
            getServicesFactory().getObjectService().deleteObject(new DeleteObject(getAndAssertRepositoryId(), document1Id, true));
        }
        else
        {
    ...
    private void assertFoldersLeading(CmisObjectType[] objects, List<Pair<Integer, Integer>> layersDescriptor) throws Exception
    {
        ...
        for (Pair<Integer, Integer> currentDescriptor : layersDescriptor)
        {
            ...
            else
            {
                ...
                do
                {
                    baseType = (currentStartIndex < objects.length) ? (getStringProperty(objects[currentStartIndex].getProperties(), PROP_BASE_TYPE)) : (null);
