...
public class RepositoryServiceLocator extends org.apache.axis.client.Service implements org.alfresco.repo.webservice.repository.RepositoryService {
 ...
 */
    ...
    public org.alfresco.repo.webservice.repository.RepositoryServiceSoapPort getRepositoryService() throws javax.xml.rpc.ServiceException {
    ...
    public org.alfresco.repo.webservice.repository.RepositoryServiceSoapPort getRepositoryService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.alfresco.repo.webservice.repository.RepositoryServiceSoapBindingStub _stub = new org.alfresco.repo.webservice.repository.RepositoryServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.alfresco.repo.webservice.repository.RepositoryServiceSoapPort.class.isAssignableFrom(serviceEndpointInterface)) {
                org.alfresco.repo.webservice.repository.RepositoryServiceSoapBindingStub _stub = new org.alfresco.repo.webservice.repository.RepositoryServiceSoapBindingStub(new java.net.URL(RepositoryService_address), this);
                _stub.setPortName(getRepositoryServiceWSDDServiceName());
                return _stub;
            }
        }
