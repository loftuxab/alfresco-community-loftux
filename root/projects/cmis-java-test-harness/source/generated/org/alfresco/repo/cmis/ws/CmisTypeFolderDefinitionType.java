...
{
    private static final long serialVersionUID = -2207620448525130608L;

    public CmisTypeFolderDefinitionType()
    {
    }

    public CmisTypeFolderDefinitionType(java.lang.String id, java.lang.String localName, org.apache.axis.types.URI localNamespace, java.lang.String displayName,
    ...
    {
        if (!(obj instanceof CmisTypeFolderDefinitionType))
            return false;
        if (obj == null)
            return false;
        if (this == obj)
    ...
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(CmisTypeFolderDefinitionType.class, true);

    static
    {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://docs.oasis-open.org/ns/cmis/core/200901", "cmisTypeFolderDefinitionType"));
    }
