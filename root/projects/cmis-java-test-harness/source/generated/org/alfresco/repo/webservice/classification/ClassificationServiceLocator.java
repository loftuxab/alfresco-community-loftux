...
public class ClassificationServiceLocator extends org.apache.axis.client.Service implements org.alfresco.repo.webservice.classification.ClassificationService {
 ...
 */
    ...
    public org.alfresco.repo.webservice.classification.ClassificationServiceSoapPort getClassificationService() throws javax.xml.rpc.ServiceException {
    ...
    public org.alfresco.repo.webservice.classification.ClassificationServiceSoapPort getClassificationService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.alfresco.repo.webservice.classification.ClassificationServiceSoapBindingStub _stub = new org.alfresco.repo.webservice.classification.ClassificationServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.alfresco.repo.webservice.classification.ClassificationServiceSoapPort.class.isAssignableFrom(serviceEndpointInterface)) {
                org.alfresco.repo.webservice.classification.ClassificationServiceSoapBindingStub _stub = new org.alfresco.repo.webservice.classification.ClassificationServiceSoapBindingStub(new java.net.URL(ClassificationService_address), this);
                _stub.setPortName(getClassificationServiceWSDDServiceName());
                return _stub;
            }
        }
