...
public class ContentServiceLocator extends org.apache.axis.client.Service implements org.alfresco.repo.webservice.content.ContentService {
 ...
 */
    ...
    public org.alfresco.repo.webservice.content.ContentServiceSoapPort getContentService() throws javax.xml.rpc.ServiceException {
    ...
    public org.alfresco.repo.webservice.content.ContentServiceSoapPort getContentService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.alfresco.repo.webservice.content.ContentServiceSoapBindingStub _stub = new org.alfresco.repo.webservice.content.ContentServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.alfresco.repo.webservice.content.ContentServiceSoapPort.class.isAssignableFrom(serviceEndpointInterface)) {
                org.alfresco.repo.webservice.content.ContentServiceSoapBindingStub _stub = new org.alfresco.repo.webservice.content.ContentServiceSoapBindingStub(new java.net.URL(ContentService_address), this);
                _stub.setPortName(getContentServiceWSDDServiceName());
                return _stub;
            }
        }
