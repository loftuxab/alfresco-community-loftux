...
{
    private static final long serialVersionUID = 6814457033054034783L;
    ...
    public CmisTypeRelationshipDefinitionType(java.lang.String id, java.lang.String localName, org.apache.axis.types.URI localNamespace, java.lang.String displayName,
            ...
            org.alfresco.repo.cmis.ws.CmisPropertyUriDefinitionType[] propertyUriDefinition, org.apache.axis.message.MessageElement[] _any, java.lang.String[] allowedSourceTypes,
            java.lang.String[] allowedTargetTypes)
    {
        super(id, localName, localNamespace, displayName, queryName, description, baseTypeId, parentId, creatable, fileable, queryable, fulltextindexed, includedInSupertypeQuery,
                controllablePolicy, controllableACL, propertyBooleanDefinition, propertyDateTimeDefinition, propertyDecimalDefinition, propertyIdDefinition,
                propertyIntegerDefinition, propertyHtmlDefinition, propertyXhtmlDefinition, propertyStringDefinition, propertyXmlDefinition, propertyUriDefinition, _any);
    ...
    {
        if (!(obj instanceof CmisTypeRelationshipDefinitionType))
            return false;
        ...
        _equals = super.equals(obj)
                && ((this.allowedSourceTypes == null && other.getAllowedSourceTypes() == null) || (this.allowedSourceTypes != null && java.util.Arrays.equals(
                        this.allowedSourceTypes, other.getAllowedSourceTypes())))
                && ((this.allowedTargetTypes == null && other.getAllowedTargetTypes() == null) || (this.allowedTargetTypes != null && java.util.Arrays.equals(
                        this.allowedTargetTypes, other.getAllowedTargetTypes())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode()
    {
        ...
        {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getAllowedSourceTypes()); i++)
            {
        ...
        {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getAllowedTargetTypes()); i++)
            {
    ...
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(CmisTypeRelationshipDefinitionType.class, true);

    static
    {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://docs.oasis-open.org/ns/cmis/core/200901", "cmisTypeRelationshipDefinitionType"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("allowedSourceTypes");
        elemField.setXmlName(new javax.xml.namespace.QName("http://docs.oasis-open.org/ns/cmis/core/200901", "allowedSourceTypes"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://docs.oasis-open.org/ns/cmis/core/200901", "allowedTargetTypes"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
