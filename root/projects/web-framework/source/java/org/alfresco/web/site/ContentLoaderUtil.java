...
public class ContentLoaderUtil 
{
	 ...
	 */
	public synchronized static ResourceContent loadContent(RequestContext context, String objectId)
	...
	public synchronized static ResourceContent loadContent(RequestContext context, String objectId, String endpointId)
		throws ContentLoaderException
	{
		return _loadContent(context, objectId, endpointId);
	}

	private synchronized static ResourceContent _loadContent(RequestContext context, String objectId, String endpointId)
		throws ContentLoaderException
	{
		if(loaderCache == null)
		{
		...
		{
			ResourceLoaderDescriptor descriptor = (ResourceLoaderDescriptor) context.getConfig().getResourceLoaderDescriptor(ids[i]);
			if(descriptor != null)
			{
				...
				if(loader == null)
				{
					...
					loader = (ResourceLoader) ReflectionHelper.newObject(loaderClassName, argTypes, args);   				
					if(loader == null)
					{
						throw new ContentLoaderException("Unable to instantiate resource loader for class: " + loaderClassName);
					}
				...
				if(endpointId != null && endpointId.equals(loader.getEndpointId()))
				{
					...
					if(loader.canHandle(objectId))
					{
						...
						{
							throw new ContentLoaderException("Unable to retrieve resource for object: " + objectId, rle);
						}
					}
				}
			}
