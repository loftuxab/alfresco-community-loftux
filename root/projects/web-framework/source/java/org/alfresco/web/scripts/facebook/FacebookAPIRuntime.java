...
{
    private FacebookServletRequest facebookReq;
    ...
    {
        facebookReq = new FacebookServletRequest(this, req, match, serverProperties, getScriptUrl());
        return facebookReq;
    }
    ...
    public Map<String, Object> getScriptParameters()
    {
        ...
        model.put("facebook", new FacebookModel(facebookReq));
        return model;
    }
