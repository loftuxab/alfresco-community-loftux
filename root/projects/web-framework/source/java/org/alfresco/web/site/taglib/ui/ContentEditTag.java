...
public class ContentEditTag extends ContentTagBase
{
    ...
    public int doStartTag() throws JspException
    {
        if (Framework.getConfig().isInContextEnabled())
        {
            ...
            // get the url
            String url = RenderUtil.getContentEditURL(context, getEndpoint(),
                    getId());
            ...
            if (iconUri != null)
                newIconUri = iconUri;
            newIconUri = RenderUtil.toBrowserUrl(newIconUri);
            ...
            buffer.append("<div id='ipe-" + context.getModelManager().newGUID() + "'>");
