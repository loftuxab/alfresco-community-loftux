...
import org.alfresco.web.framework.resource.ModelObjectResourceStore;
import org.alfresco.web.framework.resource.Resource;
import org.alfresco.web.framework.resource.ResourceImpl;
import org.alfresco.web.framework.resource.ResourceProvider;
import org.alfresco.web.framework.resource.ResourceStore;
    	...
    	if(object != null)
    	{
    		...
    		{    			
    			...
    			if(getId() != null && object instanceof ResourceProvider)
    			{
	    			...
	    			String uri = resource.getProxiedDownloadURI((HttpServletRequest)this.getPageContext().getRequest());    			
	    			if("metadata".equalsIgnoreCase(this.target))
	    			{
	    				uri = resource.getProxiedMetadataURI((HttpServletRequest)this.getPageContext().getRequest());
	    			}
