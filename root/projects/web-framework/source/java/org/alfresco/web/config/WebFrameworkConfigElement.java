...
////////////////////////////    
    ...
    {
    	return toStringArray(this.formats.keySet().toArray());
    }
    ...
    {
    	return toStringArray(this.pageMappers.keySet().toArray());
    }
    ...
    {
    	return toStringArray(this.linkBuilders.keySet().toArray());
    }
    ...
    {
    	return toStringArray(this.requestContexts.keySet().toArray());
    }
    ...
    {
    	return toStringArray(this.errorHandlers.keySet().toArray());
    }
    ...
    {
    	return toStringArray(this.systemPages.keySet().toArray());
    }
    ...
    {
    	return toStringArray(this.fileSystems.keySet().toArray());
    }
    ...
    {
    	return toStringArray(this.tagLibraries.keySet().toArray());
    }
    ...
    {
    	return toStringArray(this.userFactories.keySet().toArray());
    }
    ...
    {
    	return toStringArray(this.renderers.keySet().toArray());
    }
    ...
    {
    	return toStringArray(this.types.keySet().toArray());
    }
