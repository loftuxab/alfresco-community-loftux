 ...
 * License.
 */
package org.alfresco.sample.loggerAction;
...
{
    /** The logger */
    private static Log logger = LogFactory.getLog(LoggerActionExecuter.class); 
    
    /** The name of the action */
    public static final String NAME = "logger-action";    
    
    /** The parameter names */
    public static final String PARAM_LOG_MESSAGE = "param_log_message";
    public static final String PARAM_LOG_LEVEL = "param_log-level";
