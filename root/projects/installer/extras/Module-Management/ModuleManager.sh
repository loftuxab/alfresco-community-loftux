...
SET TEMP_CLASS_PATH=%LIB_DIR%/alfresco-repository.jar;%LIB_DIR%/alfresco-core.jar;%LIB_DIR%/truezip.jar;%LIB_DIR%/log4j-1.2.8.jar;%LIB_DIR%\spring.jar;%LIB_DIR%\commons-logging.jar
