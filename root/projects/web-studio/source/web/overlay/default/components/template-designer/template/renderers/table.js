...
{             
    ...
    this.template.setHeight(this.instance.height);
    
    this.template.setWidth(this.instance.width);
...
{                      
    ...
    if(rowsArray && rowsArray != 'undefined' && rowsArray.length > 0)
    {        	
        ...
        {                                  
            ...
            if(colArray && colArray != 'undefined' && colArray.length > 0)
            {
                for(var colIndx=0;colIndx < colArray.length;colIndx++)
                {
                    ...
                    if(regionArray && regionArray != 'undefined' && regionArray.length > 0)
                    {                    	
                        for(var regionIndx=0;regionIndx < regionArray.length;regionIndx++)
                        {
                            ...
                            // Set region height in percentage.
                            templateRegionObject.setHeight(regionObject.height);
