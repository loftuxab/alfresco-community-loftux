    		...
    		HttpServletResponse response) throws ServletException, IOException
	{
    	...
    	if(buffer == null)
    	{
    		try
    		{
	    		...
	    		OverlayUtil.include(request, buffer, "/overlay/default/core.js.jsp");
		    		
	    		// Execute Javascript compression (if configured)
	    		if(WebStudio.getConfig().isJavascriptCompressionEnabled())
	    		{
	    			String value = WebStudio.compressJavascript(buffer);
	    			buffer = new StringBuilder(65536);
	    			buffer.append(value);
	    		}
