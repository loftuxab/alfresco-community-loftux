...
public class RecordsManagementTest extends BaseSpringTest 
{
    ...
    public void testScheduledCutOffScript()
    {
        ...
        ScriptLocation location = new ClasspathScriptLocation("alfresco/rm/script/scheduled/scheduled_cutoff.js");
    ...
    public void testScheduledRemoveHoldScript()
    {
        ...
        ScriptLocation location = new ClasspathScriptLocation("alfresco/rm/script/scheduled/scheduled_removeHold.js");
        this.scriptService.executeScript(location, null);        
