...
{   
   ...
   YAHOO.namespace('com.alfresco.awe.ui.LoginPanel');
    ...
    * @constructor
    */
   YAHOO.com.alfresco.awe.ui.LoginPanel = function(containerId)
   {
      ...
      YAHOO.com.alfresco.awe.ui.LoginPanel.superclass.constructor.call(this, 'com.alfresco.awe.ui.LoginPanel', containerId, ["button", "container", "connection", "selector", "json"]);
      return this;
   };
   
   YAHOO.extend(YAHOO.com.alfresco.awe.ui.LoginPanel, YAHOO.com.alfresco.awe.ui.Panel,
   {
      /**
...
WEF.register("com.alfresco.awe.ui.login-panel", YAHOO.com.alfresco.awe.ui.LoginPanel, {version: "1.0", build: "1"});