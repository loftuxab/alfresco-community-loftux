(function()
{
   ...
   YAHOO.namespace('com.alfresco.awe.ui.FormPanel');
   /**
    * FormPanel constructor.
    *
    * @param containerId {string} A unique id for this component
    * @return {YAHOO.com.alfresco.awe.ui.FormPanel} The new DocumentList instance
    * @constructor
    */
   YAHOO.com.alfresco.awe.ui.FormPanel = function(containerId)
   {
      ...
      YAHOO.com.alfresco.awe.ui.FormPanel.superclass.constructor.call(this, "com.alfresco.awe.ui.FormPanel", containerId, ["button", "container", "connection", "selector", "json"]);
   
      return this;
   };
   
   YAHOO.extend(YAHOO.com.alfresco.awe.ui.FormPanel, YAHOO.com.alfresco.awe.ui.Panel,
   {
      /**
       * Shows the dialog
       *
...
WEF.register("com.alfresco.awe.ui.form-panel", YAHOO.com.alfresco.awe.ui.FormPanel, {version: "1.0", build: "1"});   