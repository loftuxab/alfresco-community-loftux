 ...
 * time for the Web Editor project.
 * 
 ...
 * @author kevinr
 */
public class WebEditorPageMapper extends AbstractPageMapper
{
    /**
     * Constructor
     * 
     ...
     */
    public WebEditorPageMapper(WebFrameworkServiceRegistry serviceRegistry)
    {
        ...
        ServletRequest request) throws PageMapperException
    {
        ...
        /**
         * At present, the Web Editor project doesn't do much with formats.
         * 
