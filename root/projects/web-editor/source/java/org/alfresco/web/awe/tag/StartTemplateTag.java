...
/**
 * Tag used in the head section of a page to indicate that the page
 * potentially contains editable Alfresco content.
 * 
...
public class StartTemplateTag extends AbstractWebEditorTag
{
    ...
    public int doStartTag() throws JspException
    {
        ...
        try
        {
            ...
            //       all the code below and resolve the locale and username todo's below!
            ...
            out.write(contextPath);
            out.write("/proxy/alfresco/\";\n");
            // *** TODO: extract this out, make it configurable
            ...
            out.write(contextPath);
            out.write("/service/\";\n");
            // *** TODO: get this from the session/cookies some how!
            ...
            // TODO: output full versions if debug is true
            out.write("<script type=\"text/javascript\" src=\"");
            out.write(contextPath);
