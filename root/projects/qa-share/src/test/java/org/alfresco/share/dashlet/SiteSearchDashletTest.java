...
public class SiteSearchDashletTest extends AbstractUtils
{
    ...
    @Test(groups = { "DataPrepEnterpriseOnly" })
    public void dataPrep_AONE_14777() throws Exception
    {
    ...
    @Test(groups = {"EnterpriseOnly"})
    public void AONE_14777() throws Exception
    {
    ...
    @Test(groups = { "DataPrepEnterpriseOnly" })
    public void dataPrep_AONE_14778() throws Exception
    {
    ...
    @Test(groups = {"EnterpriseOnly"})
    public void AONE_14778() throws Exception
    {
    ...
    @Test(groups = { "DataPrepEnterpriseOnly" })
    public void dataPrep_AONE_14779() throws Exception
    {
    ...
    @Test(groups = {"EnterpriseOnly"})
    public void AONE_14779() throws Exception
    {
    ...
    @Test(groups = { "DataPrepEnterpriseOnly" })
    public void dataPrep_AONE_14780() throws Exception
    {
    ...
    @Test(groups = {"EnterpriseOnly"})
    public void AONE_14780() throws Exception
    {
