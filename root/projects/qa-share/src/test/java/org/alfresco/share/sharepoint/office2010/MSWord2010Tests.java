...
public class MSWord2010Tests extends AbstractUtils
{
        ...
        public void AONE_9644() throws Exception
        {
                ...
                DocumentDetailsPage detailsPage = documentLibPage.selectFile(docFileName_9644 + fileType).render();
                Map<String, Object> properties = detailsPage.getProperties();
                Assert.assertEquals(properties.get("Name"), docFileName_9644 + " (Working Copy)" + fileType);
                ...
                Assert.assertTrue(
                        ShareUserSitePage.getDocTreeMenuWithRetry(drone, docFileName_9644 + fileType, TreeMenuNavigation.DocumentsMenu.IM_EDITING, true),
                        docFileName_9644 + fileType + " cannot be found.");
        ...
        public void AONE_9647() throws Exception
        {
                ...
                DocumentDetailsPage detailsPage = documentLibPage.selectFile(docFileName_9647 + fileType).render();
                Assert.assertEquals(detailsPage.getContentInfo(), "This document is locked by you for offline editing.");
                Map<String, Object> properties = detailsPage.getProperties();
                Assert.assertEquals(properties.get("Name"), docFileName_9647 + " (Working Copy)" + fileType);
        }
        ...
        public void AONE_9648() throws Exception
        {
                ...
                treeMenuNavigation.selectDocumentNode(TreeMenuNavigation.DocumentsMenu.IM_EDITING).render();
                Assert.assertTrue(
                        ShareUserSitePage.getDocTreeMenuWithRetry(drone, docFileName_9648 + fileType, TreeMenuNavigation.DocumentsMenu.IM_EDITING, true),
                        docFileName_9648 + fileType + " cannot be found.");
        ...
        public void AONE_9649() throws Exception
        {
                ...
                String actualName2 = word.getAbstractUtil().findWindowName(docFileName_9649);
                Assert.assertTrue(actualName2.contains("[Read-Only]"), "Word is NOT opened in read only mode");
        ...
        public void AONE_9650() throws Exception
        {
                ...
                String actualName = word.getAbstractUtil().findWindowName(docFileName_9650);
                Assert.assertTrue(actualName.contains(docFileName_9650) && actualName.contains("Word"), "File not found");

                Ldtp l1 = word.getAbstractUtil().setOnWindow(docFileName_9650);
                ...
                // 1. Make some changes to the workbook;
                Ldtp l2 = word.getAbstractUtil().setOnWindow(docFileName_9650);
                word.editOffice(l2, testName);
                ...
                // 5. Click OK button;
                String commentFromWord = "comment from word file check in";
                word.operateOnCheckIn(l2, commentFromWord, true);
                ...
                FileDirectoryInfo fileInfo = ShareUserSitePage.getFileDirectoryInfo(drone, docFileName_9650 + fileType);

                assertEquals(fileInfo.getContentInfo(), "This document is locked by you for offline editing.", "File " + docFileName_9650 + " isn't locked");

                documentLibPage.getFileDirectoryInfo(docFileName_9650 + fileType).selectCancelEditing().render();

                // 8. Navigate the document;
                DocumentDetailsPage detailsPage = documentLibPage.selectFile(docFileName_9650 + fileType).render();
        ...
        public void AONE_9651() throws Exception
        {
                ...
                DocumentDetailsPage detailsPage = documentLibPage.selectFile(docFileName_9651 + fileType).render();

                // 6. Changes are not applied to the original file; Version is not
                // increased to new major one.
                String documentContent = detailsPage.getDocumentBody();
                Assert.assertFalse(documentContent.contains(testName), "Changes are applied to the document.");
        ...
        public void AONE_9660() throws Exception
        {
                ...
                String documentContent = detailsPage.getDocumentBody();
                Assert.assertFalse(documentContent.contains(testName), "Changes are not applied to the document.");
        ...
        public void AONE_9662() throws Exception
        {
                ...
                DocumentDetailsPage detailsPage = documentLibPage.selectFile(docFileName_9662 + fileType).render();
                assertEquals(detailsPage.getContentInfo(), "This document is locked by you for offline editing.", "File " + docFileName_9662 + " isn't locked");

                String documentContent = detailsPage.getDocumentBody();
                Assert.assertFalse(documentContent.contains(docFileName_9662), "Changes are applied to the document.");
        }
