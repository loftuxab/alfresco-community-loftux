...
{
    private static Log logger = LogFactory.getLog(LocalizationTests.class);
    ...
    public void setup() throws Exception
    {
        ...
        userCloudEmail = googleUserName;
        userCoundPassword = googlePassword;

        logger.info("Starting Tests: " + testName);
    }

    @AfterMethod(alwaysRun = true, groups = { "Localization", "CloudOnly" })
    ...
    public void dataPrep_AONE_12745() throws Exception
    {
        ...
        CreateUserAPI.CreateActivateUser(drone, ADMIN_USERNAME, testUserInfo12745E);

        String[] testUserInfo12745F = new String[] { testUser12745F };
        CreateUserAPI.CreateActivateUser(drone, ADMIN_USERNAME, testUserInfo12745F);

        String[] testUserInfo12745D = new String[] { testUser12745D };
        CreateUserAPI.CreateActivateUser(drone, ADMIN_USERNAME, testUserInfo12745D);

        String[] testUserInfo12745S = new String[] { testUser12745S };
        CreateUserAPI.CreateActivateUser(drone, ADMIN_USERNAME, testUserInfo12745S);

        String[] testUserInfo12745I = new String[] { testUser12745I };
        CreateUserAPI.CreateActivateUser(drone, ADMIN_USERNAME, testUserInfo12745I);
    ...
    public void dataPrep_AONE_12746() throws Exception
    {
        ...
        CreateUserAPI.createActivateUserAsTenantAdmin(drone, ADMIN_USERNAME, testUserInfo12746E);
    ...
    public void dataPrep_AONE_12747() throws Exception
    {
        ...
        CreateUserAPI.CreateActivateUser(drone, ADMIN_USERNAME, testUserInfo12747E);

        String[] testUserInfo12747F = new String[] { testUser12747F };
        CreateUserAPI.CreateActivateUser(drone, ADMIN_USERNAME, testUserInfo12747F);

        String[] testUserInfo12747D = new String[] { testUser12747D };
        CreateUserAPI.CreateActivateUser(drone, ADMIN_USERNAME, testUserInfo12747D);

        String[] testUserInfo12747S = new String[] { testUser12747S };
        CreateUserAPI.CreateActivateUser(drone, ADMIN_USERNAME, testUserInfo12747S);

        String[] testUserInfo12747I = new String[] { testUser12747I };
        CreateUserAPI.CreateActivateUser(drone, ADMIN_USERNAME, testUserInfo12747I);

        drone.navigateTo(shareUrl);
        LoginPage lp1 = new LoginPage(drone).render();
        lp1.loginAs(testUser12747E, DEFAULT_PASSWORD, Language.ENGLISH_US);
        ShareUser.logout(drone);

        drone.navigateTo(shareUrl);
        LoginPage lp2 = new LoginPage(drone).render();
        lp2.loginAs(testUser12747F, DEFAULT_PASSWORD, Language.FRENCH);
        ShareUser.logout(drone);

        drone.navigateTo(shareUrl);
        LoginPage lp4 = new LoginPage(drone).render();
        lp4.loginAs(testUser12747D, DEFAULT_PASSWORD, Language.DEUTSCHE);
        ShareUser.logout(drone);

        drone.navigateTo(shareUrl);
        LoginPage lp5 = new LoginPage(drone).render();
        lp5.loginAs(testUser12747S, DEFAULT_PASSWORD, Language.SPANISH);
        ShareUser.logout(drone);
    ...
    public void dataPrep_AONE_12748() throws Exception
    {
        ...
        drone.navigateTo(shareUrl);
        LoginPage lp1 = new LoginPage(drone).render();
        lp1.loginAs(testUser12748E, DEFAULT_PASSWORD, Language.ENGLISH_US);
        ShareUser.logout(drone);

        drone.navigateTo(shareUrl);
        LoginPage lp2 = new LoginPage(drone).render();
        lp2.loginAs(testUser12748F, DEFAULT_PASSWORD, Language.FRENCH);
        ShareUser.logout(drone);

        drone.navigateTo(shareUrl);
        LoginPage lp3 = new LoginPage(drone).render();
        lp3.loginAs(testUser12748D, DEFAULT_PASSWORD, Language.DEUTSCHE);
        ShareUser.logout(drone);

        drone.navigateTo(shareUrl);
        LoginPage lp4 = new LoginPage(drone).render();
        lp4.loginAs(testUser12748S, DEFAULT_PASSWORD, Language.SPANISH);
        ShareUser.logout(drone);

        drone.navigateTo(shareUrl);
        LoginPage lp5 = new LoginPage(drone).render();
        lp5.loginAs(testUser12748I, DEFAULT_PASSWORD, Language.ITALIAN);
        ShareUser.logout(drone);
    ...
    public void dataPrep_AONE_12750() throws Exception
    {
        ...
        String userE = getUserNameFreeDomain(testName + "12750E");
        String userF = getUserNameFreeDomain(testName + "12750F");
        String userD = getUserNameFreeDomain(testName + "12750D");
        String userI = getUserNameFreeDomain(testName + "12750I");
        String userJ = getUserNameFreeDomain(testName + "12750J");
        String userS = getUserNameFreeDomain(testName + "12750S");
    ...
    public void dataPrep_AONE_12751() throws Exception
    {
        ...
        String[] newTestUserE = new String[] { testUser12751E };
        CreateUserAPI.CreateActivateUser(drone, ADMIN_USERNAME, newTestUserE);

        String[] newTestUserF = new String[] { testUser12751F };
        CreateUserAPI.CreateActivateUser(drone, ADMIN_USERNAME, newTestUserF);
        ...
        drone.navigateTo(shareUrl);
        LoginPage lp1 = new LoginPage(drone).render();
        lp1.loginAs(testUser12751E, DEFAULT_PASSWORD, Language.ENGLISH_US);
        ShareUser.logout(drone);

        LoginPage lp2 = new LoginPage(drone).render();
        lp2.loginAs(testUser12751F, DEFAULT_PASSWORD, Language.FRENCH);
        ShareUser.logout(drone);

        LoginPage lp3 = new LoginPage(drone).render();
        lp3.loginAs(testUser12751D, DEFAULT_PASSWORD, Language.DEUTSCHE);
        ShareUser.logout(drone);

        LoginPage lp4 = new LoginPage(drone).render();
        lp4.loginAs(testUser12751S, DEFAULT_PASSWORD, Language.SPANISH);
        ShareUser.logout(drone);

        LoginPage lp5 = new LoginPage(drone).render();
        lp5.loginAs(testUser12751I, DEFAULT_PASSWORD, Language.ITALIAN);
        ShareUser.logout(drone);
    ...
    public void dataPrep_AONE_12752() throws Exception
    {
        ...
        String testUser = getUserNameFreeDomain(testName + "12752");
        ...
        drone.navigateTo(shareUrl);
        LoginPage lp1 = new LoginPage(drone).render();
        lp1.loginAs(testUser, DEFAULT_PASSWORD, Language.ENGLISH_US);
    ...
    public void AONE_12743() throws Exception
    {
        ...
        ShareUser.loginAs(drone, testUser).render();

        String emailSubject = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.ENGLISH_US), "signupemail");
        String emailSubjectWithUser = String.format(emailSubject, testUser);
        logger.info(emailSubjectWithUser);

        String emailContent = MailUtil.checkGmail(userCloudEmail, userCoundPassword, testUser, emailSubjectWithUser);
        Assert.assertTrue(!emailContent.isEmpty(), "Email was not found!");
        logger.info(emailContent);

        String expectedEmailContent = String.format(PropertiesUtil.getPropertyValue(getLocalizationFile(Language.ENGLISH_US), "activatereminder"));
        logger.info(expectedEmailContent);

        String pattern1 = expectedEmailContent;
        Pattern p = Pattern.compile(pattern1, Pattern.MULTILINE);

        Assert.assertTrue(p.matcher(emailContent).find(), "Email doesn't contain " + expectedEmailContent);
        ShareUser.logout(drone);
    ...
    public void AONE_12744() throws Exception
    {
        ...
        verifyEmailForLoginWithLangAndInviteSite(Language.ENGLISH_US, testUser1, testUser2, false);
        verifyEmailForLoginWithLangAndInviteSite(Language.FRENCH, testUser1, testUser2, false);
        verifyEmailForLoginWithLangAndInviteSite(Language.DEUTSCHE, testUser1, testUser2, false);
        verifyEmailForLoginWithLangAndInviteSite(Language.ITALIAN, testUser1, testUser2, false);
        verifyEmailForLoginWithLangAndInviteSite(Language.SPANISH, testUser1, testUser2, false);
    ...
    public void AONE_12746() throws Exception
    {
        ...
        verifyEmailForInvitePeople(testUser12746E, Language.ENGLISH_US, testUser12746E2);
        verifyEmailForInvitePeople(testUser12746E, Language.FRENCH, testUser12745F);
        verifyEmailForInvitePeople(testUser12746E, Language.DEUTSCHE, testUser12745D);
        verifyEmailForInvitePeople(testUser12746E, Language.SPANISH, testUser12745S);
        verifyEmailForInvitePeople(testUser12746E, Language.ITALIAN, testUser12745I);

    }

    //
    private void verifyEmailForCreateTask(String loginUser, Language loginLanguage) throws Exception
    {
        // --- Step 1 ---
        // --- Step action ---
        ...
        StartWorkFlowPage.startTaskWorkflow(drone, taskName, loginUser, fileName_12745, siteName).render();

        // verify the email format
        String emailSubject = PropertiesUtil.getPropertyValue(getLocalizationFile(loginLanguage), "createtasksubject");
        String formattedEmailSubject = String.format(emailSubject, loginUser);
        String emailContent = MailUtil.checkGmail(userCloudEmail, userCoundPassword, loginUser, formattedEmailSubject);
        Assert.assertTrue(!emailContent.isEmpty(), "Email was not found!");

        String expectedContent1 = PropertiesUtil.getPropertyValue(getLocalizationFile(loginLanguage), "createtaskbody");
        Assert.assertTrue(emailContent.contains(expectedContent1));

        String expectedContent2 = PropertiesUtil.getPropertyValue(getLocalizationFile(loginLanguage), "createtaskname");
        String expectedEmailContent2 = String.format(expectedContent2, taskName);
    ...
    // // locale);
    //
    // // verifyEmailForPeopleFinderAndFollow(testUser12747E, Language.ENGLISH_US, testUser12747F, Language.FRENCH);
    //
    // // drone.createNewTab();
    // verifyEmailForPeopleFinderAndFollow(testUser12747F, Language.FRENCH, testUser12747E, Language.ENGLISH_US);
    // // drone.closeTab();
    // // --- Step 3 ---
    // // --- Step action ---
    ...
    // // For DEUTSCHE
    //
    // verifyEmailForPeopleFinderAndFollow(testUser12747E, Language.ENGLISH_US, testUser12747D, Language.DEUTSCHE);
    //
    // verifyEmailForPeopleFinderAndFollow(testUser12747D, Language.DEUTSCHE, testUser12747E, Language.ENGLISH_US);
    //
    // verifyEmailForPeopleFinderAndFollow(testUser12747E, Language.ENGLISH_US, testUser12747S, Language.SPANISH);
    // verifyEmailForPeopleFinderAndFollow(testUser12747S, Language.SPANISH, testUser12747E, Language.ENGLISH_US);
    //
    // verifyEmailForPeopleFinderAndFollow(testUser12747E, Language.ENGLISH_US, testUser12747I, Language.ITALIAN);
    // verifyEmailForPeopleFinderAndFollow(testUser12747I, Language.ITALIAN, testUser12747E, Language.ENGLISH_US);
    //
    // }
    ...
    public void AONE_12748() throws Exception
    {
        ...
        emailSubject = String.format(PropertiesUtil.getPropertyValue(getLocalizationFile(Language.ENGLISH_US), "resetpasswordsubject"), testUser12748E);
        String emailSubjectEncoded = decodingString(emailSubject);
        emailContent = MailUtil.checkGmail(userCloudEmail, userCoundPassword, testUser12748E, emailSubjectEncoded);
        Assert.assertTrue(!emailContent.isEmpty(), "Email was not found!");

        expectedContent1 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.ENGLISH_US), "resetpasswordbody1");
        String expectedContent1Encoded = decodingString(expectedContent1);
        expectedContent2 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.ENGLISH_US), "resetpasswordbody2");
        String expectedContent2Encoded = decodingString(expectedContent2);
        Assert.assertTrue(emailContent.contains(expectedContent1Encoded), "Actual email: " + emailContent + " Expected: " + expectedContent1);
        Assert.assertTrue(emailContent.contains(expectedContent2Encoded), "Actual email: " + emailContent + " Expected: " + expectedContent2);
        ...
        emailSubject = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.FRENCH), "resetpasswordsubject");
        String formattedEmailSubject = String.format(emailSubject, testUser12748F);
        emailContent = MailUtil.checkGmail(userCloudEmail, userCoundPassword, testUser12748F, formattedEmailSubject);

        Assert.assertTrue(!emailContent.isEmpty(), "Email was not found!");

        expectedContent1 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.FRENCH), "resetpasswordbody1");
        expectedContent2 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.FRENCH), "resetpasswordbody2");
        Assert.assertTrue(emailContent.contains(expectedContent1));
        ...
        emailSubject = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.DEUTSCHE), "resetpasswordsubject");
        formattedEmailSubject = String.format(emailSubject, testUser12748D);
        emailContent = MailUtil.checkGmail(userCloudEmail, userCoundPassword, testUser12748D, formattedEmailSubject);
        Assert.assertTrue(!emailContent.isEmpty(), "Email was not found!");

        expectedContent1 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.DEUTSCHE), "resetpasswordbody1");
        expectedContent2 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.DEUTSCHE), "resetpasswordbody2");
        Assert.assertTrue(emailContent.contains(expectedContent1));
        Assert.assertTrue(emailContent.contains(expectedContent2));
        ...
        emailSubject = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.ITALIAN), "resetpasswordsubject");
        formattedEmailSubject = String.format(emailSubject, testUser12748I);
        emailContent = MailUtil.checkGmail(userCloudEmail, userCoundPassword, testUser12748I, formattedEmailSubject);
        Assert.assertTrue(!emailContent.isEmpty(), "Email was not found!");

        expectedContent1 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.ITALIAN), "resetpasswordbody1");
        expectedContent2 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.ITALIAN), "resetpasswordbody2");
        Assert.assertTrue(emailContent.contains(expectedContent1));
        Assert.assertTrue(emailContent.contains(expectedContent2));
        ...
        emailSubject = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.SPANISH), "resetpasswordsubject");
        formattedEmailSubject = String.format(emailSubject, testUser12748S);
        emailContent = MailUtil.checkGmail(userCloudEmail, userCoundPassword, testUser12748S, formattedEmailSubject);
        Assert.assertTrue(!emailContent.isEmpty(), "Email was not found!");

        expectedContent1 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.SPANISH), "resetpasswordbody1");
        expectedContent2 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.SPANISH), "resetpasswordbody2");
        Assert.assertTrue(emailContent.contains(expectedContent1));
        Assert.assertTrue(emailContent.contains(expectedContent2));
    ...
    {
        String userE = getUserNameFreeDomain(testName + "12749E");
        String userF = getUserNameFreeDomain(testName + "12749F");
        String userD = getUserNameFreeDomain(testName + "12749D");
        String userI = getUserNameFreeDomain(testName + "12749I");
        String userJ = getUserNameFreeDomain(testName + "12749J");
        String userS = getUserNameFreeDomain(testName + "12749S");

        // getUserNameForDomain
        ...
        login.changeLanguage(Language.ENGLISH_US);
        operateOnForgotPasswordPage(forgotUrl, Language.ENGLISH_US, userE, false);
        ...
        login.changeLanguage(Language.FRENCH);
        operateOnForgotPasswordPage(forgotUrl, Language.ENGLISH_US, userF, false);
        ...
        login.changeLanguage(Language.DEUTSCHE);
        operateOnForgotPasswordPage(forgotUrl, Language.ENGLISH_US, userD, false);

        login.changeLanguage(Language.ITALIAN);
        operateOnForgotPasswordPage(forgotUrl, Language.ENGLISH_US, userI, false);

        login.changeLanguage(Language.JAPANESE);
        operateOnForgotPasswordPage(forgotUrl, Language.ENGLISH_US, userJ, false);

        login.changeLanguage(Language.SPANISH);
        operateOnForgotPasswordPage(forgotUrl, Language.ENGLISH_US, userS, false);
    }
    ...
    public void AONE_12751() throws Exception
    {
        ...
        drone.navigateTo(shareUrl);
        LoginPage loginPage = new LoginPage(drone).render();
        loginPage.loginAs(testUser12751E, DEFAULT_PASSWORD, Language.ENGLISH_US);
        CreateUserAPI.CreateActivateUser(drone, ADMIN_USERNAME, testUser1);

        emailSubject = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.ENGLISH_US), "registersubject");
        emailSubjectWithUser = String.format(emailSubject, testUser12751E);
        emailContent = MailUtil.checkGmail(userCloudEmail, userCoundPassword, testUser12751E, emailSubjectWithUser);
        Assert.assertTrue(!emailContent.isEmpty(), "Email was not found!");

        expectedContent1 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.ENGLISH_US), "registerbody1");
        Assert.assertTrue(emailContent.contains(expectedContent1), "Email doesn't contain" + expectedContent1);

        expectedContent1 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.ENGLISH_US), "labelcapabilities");
        Assert.assertTrue(emailContent.contains(expectedContent1), "Email doesn't contain" + expectedContent1);
        ...
        emailSubject = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.FRENCH), "registersubject");
        emailSubjectWithUser = String.format(emailSubject, testUser12751F);
        emailContent = MailUtil.checkGmail(userCloudEmail, userCoundPassword, testUser12751F, emailSubjectWithUser);
        Assert.assertTrue(!emailContent.isEmpty(), "Email was not found!");

        expectedContent1 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.FRENCH), "registerbody1");
        Assert.assertTrue(emailContent.contains(expectedContent1), "Email doesn't contain" + expectedContent1);

        expectedContent1 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.FRENCH), "registerbody2");
        Assert.assertTrue(emailContent.contains(expectedContent1), "Email doesn't contain" + expectedContent1);
        ...
        emailSubject = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.DEUTSCHE), "registersubject");
        emailSubjectWithUser = String.format(emailSubject, testUser12751D);
        emailContent = MailUtil.checkGmail(userCloudEmail, userCoundPassword, testUser12751D, emailSubjectWithUser);
        Assert.assertTrue(!emailContent.isEmpty(), "Email was not found!");

        expectedContent1 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.DEUTSCHE), "registerbody1");
        Assert.assertTrue(emailContent.contains(expectedContent1), "Email doesn't contain " + expectedContent1);

        expectedContent1 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.DEUTSCHE), "registerbody2");
        Assert.assertTrue(emailContent.contains(expectedContent1), "Email doesn't contain " + expectedContent1);
        ...
        emailSubject = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.SPANISH), "registersubject");
        emailSubjectWithUser = String.format(emailSubject, testUser12751S);
        emailContent = MailUtil.checkGmail(userCloudEmail, userCoundPassword, testUser12751S, emailSubjectWithUser);
        Assert.assertTrue(!emailContent.isEmpty(), "Email was not found!");

        expectedContent1 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.SPANISH), "registerbody1");
        Assert.assertTrue(emailContent.contains(expectedContent1), "Email doesn't contain" + expectedContent1);

        expectedContent1 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.SPANISH), "registerbody2");
        Assert.assertTrue(emailContent.contains(expectedContent1), "Email doesn't contain" + expectedContent1);
        ...
        emailSubject = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.ITALIAN), "registersubject");
        emailSubjectWithUser = String.format(emailSubject, testUser12751I);
        emailContent = MailUtil.checkGmail(userCloudEmail, userCoundPassword, testUser12751I, emailSubjectWithUser);
        Assert.assertTrue(!emailContent.isEmpty(), "Email was not found!");

        expectedContent1 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.ITALIAN), "registerbody1");
        Assert.assertTrue(emailContent.contains(expectedContent1), "Email doesn't contain" + expectedContent1);

        expectedContent1 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.ITALIAN), "registerbody2");
        Assert.assertTrue(emailContent.contains(expectedContent1), "Email doesn't contain" + expectedContent1);
    ...
    public void AONE_12754() throws Exception
    {
        ...
        long newUser = System.currentTimeMillis();

        String testUserToInvite1 = getUserNameFreeDomain(testName + newUser + "E");
        String testUserToInvite2 = getUserNameFreeDomain(testName + newUser + "F");
        String testUserToInvite3 = getUserNameFreeDomain(testName + newUser + "I");
        String testUserToInvite4 = getUserNameFreeDomain(testName + newUser + "S");
        String testUserToInvite5 = getUserNameFreeDomain(testName + newUser + "D");
        ...
        verifyEmailForInviteToSite(testUser12754E, testUserToInvite1, Language.ENGLISH_US, true);
        verifyEmailForInviteToSite(testUser12754I, testUserToInvite3, Language.ITALIAN, true);
        verifyEmailForInviteToSite(testUser12754F, testUserToInvite2, Language.FRENCH, true);
        verifyEmailForInviteToSite(testUser12754S, testUserToInvite4, Language.SPANISH, true);
        verifyEmailForInviteToSite(testUser12754D, testUserToInvite5, Language.DEUTSCHE, true);

    }

    private void verifyActivitiesFeed(String testUser, String siteName, String fileName, Language selectedLang)
    {
        ...
        siteDashBoard = dashlet.selectUserFilter(SiteActivitiesUserFilter.MY_ACTIVITIES).render();

        List<String> activities = dashlet.getSiteActivityDescriptions();

        String addText = " " + PropertiesUtil.getPropertyValue(getLocalizationFile(selectedLang), "activityadddocument") + " ";
        String addedFeed;
        if (selectedLang != Language.DEUTSCHE)
            addedFeed = testUser + " " + DEFAULT_LASTNAME + addText + fileName;
        else
        {
            String lastAdded = PropertiesUtil.getPropertyValue(getLocalizationFile(selectedLang), "activityadddocumentlast");
            addedFeed = testUser + " " + DEFAULT_LASTNAME + addText + fileName + " " + lastAdded;
        }
        Assert.assertTrue(activities.contains(addedFeed), "Activities feed does not contain " + addedFeed);
    }

    private void verifyEmailForInviteToSite(String testUser1, String testUser2, Language language, boolean verifyAcceptLink) throws Exception
    {
        ...
        String siteName = testName + language.getLanguageValue().replace("_", "") + System.currentTimeMillis();
        ...
        {
            formattedEmailSubject = String.format(emailSubject, testUser2, getUserFullName(testUser1), siteName);
        }
        else
        {
            formattedEmailSubject = String.format(emailSubject, testUser2, siteName);
        }

        String emailContent = MailUtil.checkGmail(userCloudEmail, userCoundPassword, testUser1, formattedEmailSubject);
        Assert.assertTrue(!emailContent.isEmpty(), "Email was not found!");

        String expectedContent = PropertiesUtil.getPropertyValue(getLocalizationFile(language), "invitationbody");
        String expectedEmailContent = String.format(expectedContent, getUserFullName(testUser1), siteName);
        ...
        if (verifyAcceptLink)
        {
            ...
            String acceptLink = PropertiesUtil.getPropertyValue(getLocalizationFile(language), "invitationacceptlink");
            Pattern p = Pattern.compile("<a href=\".*\">" + acceptLink + "</a>", Pattern.MULTILINE);
            Matcher m = p.matcher(emailContent);
            if (m.find())
            {
                String linkAcceptInvitation = m.group().replace("<a href=\"", "").replace("\">" + acceptLink + "</a>", "");
                verifyAcceptInvitationLink(linkAcceptInvitation, language, testUser1, siteName);
            }
            else
    ...
    private void verifyAcceptInvitationLink(String linkAcceptInvitation, Language language, String user, String site) throws InterruptedException
    {
        drone.createNewTab();
        drone.navigateTo(linkAcceptInvitation);
        drone.waitForElement(By.cssSelector("div.read-flow"), 3);

        WebElement elem = drone.findAndWait(By.cssSelector("div.read-flow"));
        String actualInvitation = elem.getText();

        String expectedWelcome = PropertiesUtil.getPropertyValue(getLocalizationFile(language), "inviationacceptwelcome");
        String expectedBody = PropertiesUtil.getPropertyValue(getLocalizationFile(language), "inviationaccept1");
        String expectedAcceptInvitation = String.format(expectedBody, getUserFullName(user), site);

        Assert.assertTrue(actualInvitation.contains(expectedWelcome), "Activation page doesn't contain " + expectedWelcome);
        Assert.assertTrue(actualInvitation.contains(expectedAcceptInvitation), "Activation page doesn't contain " + expectedAcceptInvitation);

        drone.closeTab();
    }

    private void verifyEmailForLoginWithLangAndInviteSite(Language language, String testUser1, String testUser2, boolean verifyAcceptLink) throws Exception
    {
        ...
        lp.loginAs(testUser1, DEFAULT_PASSWORD, language);

        // ShareUser.loginWithLanguage(drone, language, testUser1, DEFAULT_PASSWORD).render();
        ...
        if (language == Language.ENGLISH_US)
            ...
            formattedEmailSubject = decodingString(String.format(emailSubject, testUser2, siteName));

        String emailContent = MailUtil.checkGmail(userCloudEmail, userCoundPassword, testUser1, formattedEmailSubject);
        Assert.assertTrue(!emailContent.isEmpty(), "Email was not found!");

        String expectedEmailContent = String.format(PropertiesUtil.getPropertyValue(getLocalizationFile(language), "invitationbody"),
        ...
        if (verifyAcceptLink)
        {
            ...
            if (m.find())
            {
                String linkAcceptInvitation = m.group().replace("<a href=\"", "").replace("\">Accept Invitation</a>", "");
                verifyAcceptInvitationLink(linkAcceptInvitation, language, testUser1, siteName);
    ...
    private void verifyEmailForPeopleFinderAndFollow(String userLogin, Language loginLanguage, String followingUser, Language selectedLanguage)
            throws Exception
    {
        ...
        PeopleFinderPage resultPage = peopleFinderPage.searchFor(followingUser).render();
        ...
        // verify the email format
        String emailSubject = PropertiesUtil.getPropertyValue(getLocalizationFile(selectedLanguage), "createfollowsubject");
        String formattedEmailSubject = String.format(emailSubject, followingUser, getUserFullName(userLogin));
        // String emailSubjectEncoded = decodingString(selectedLanguage,
        // emailSubject);
        String emailContent = MailUtil.checkGmail(userCloudEmail, userCoundPassword, userLogin, formattedEmailSubject);
        Assert.assertTrue(!emailContent.isEmpty(), "Email was not found!");

        String expectedContent = PropertiesUtil.getPropertyValue(getLocalizationFile(selectedLanguage), "createfollowbody");
        String expectedEmailContent = String.format(expectedContent, getUserDomain(userLogin));
        Assert.assertTrue(emailContent.contains(expectedEmailContent));
    ...
    private void operateOnForgotPasswordPage(String forgotUrl, Language selectedLanguage, String userEmail, boolean registred)
    {
        String emailSubject;
        String emailSubjectWithUser;
        String emailContent;
        ...
        CloudForgotPasswordPage forgotPage = new CloudForgotPasswordPage(drone).render();
        forgotPage.clickSendInstructions(userEmail);

        if (registred == false)
        {
            emailSubject = PropertiesUtil.getPropertyValue(getLocalizationFile(selectedLanguage), "forgotpasswordsubject");
            emailSubjectWithUser = String.format(emailSubject, userEmail);
            emailContent = MailUtil.checkGmail(userCloudEmail, userCoundPassword, userEmail, emailSubjectWithUser);
            Assert.assertTrue(!emailContent.isEmpty(), "Email was not found!");

            expectedContent1 = PropertiesUtil.getPropertyValue(getLocalizationFile(Language.ENGLISH_US), "forgotpasswordbody");
            Assert.assertTrue(emailContent.contains(expectedContent1));
        }
        else
        {
            emailSubject = PropertiesUtil.getPropertyValue(getLocalizationFile(selectedLanguage), "signupemail");
            emailSubjectWithUser = String.format(emailSubject, userEmail);
            emailContent = MailUtil.checkGmail(userCloudEmail, userCoundPassword, userEmail, emailSubjectWithUser);
            Assert.assertTrue(!emailContent.isEmpty(), "Email was not found!");
            ...
            Pattern p = Pattern.compile(expectedEmailContent, Pattern.MULTILINE);
            Assert.assertTrue(p.matcher(emailContent).find(), "Email doesn't contain " + expectedEmailContent);
        }
    ...
    private void verifyEmailForInvitePeople(String loginUser, Language loginLanguage, String userToInvite)
    {
        // --- Step 1 ---
        // --- Step action ---
        ...
        AccountSettingsPage accSettingsPage = userPage.selectAccountSettingsPage().render();

        InviteToAlfrescoPage invitePage = accSettingsPage.selectManageUsers().selectInvitePeople().render();
        ...
        // verify the email format
        String emailSubject = PropertiesUtil.getPropertyValue(getLocalizationFile(loginLanguage), "invitepeoplesubject");
        String formattedEmailSubject = String.format(emailSubject, userToInvite, getUserFullName(loginUser));
        String emailContent = MailUtil.checkGmail(userCloudEmail, userCoundPassword, loginUser, formattedEmailSubject);
        Assert.assertTrue(!emailContent.isEmpty(), "Email was not found!");

        String expectedContent1 = PropertiesUtil.getPropertyValue(getLocalizationFile(loginLanguage), "invitepeoplebody1");
        String formattedExpectedContent1 = String.format(expectedContent1, getUserFullName(loginUser));
        Assert.assertTrue(emailContent.contains(formattedExpectedContent1));

        String expectedContent2 = PropertiesUtil.getPropertyValue(getLocalizationFile(loginLanguage), "invitepeoplebody2");
        String formattedExpectedContent2 = String.format(expectedContent2, getUserFullName(loginUser));
        Assert.assertTrue(emailContent.contains(formattedExpectedContent2));

        String expectedContent3 = PropertiesUtil.getPropertyValue(getLocalizationFile(loginLanguage), "invitepeoplemessage");
        String formattedExpectedContent3 = String.format(expectedContent3, messageText);
