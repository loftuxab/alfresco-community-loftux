...
public class AuthoringServiceLocator extends org.apache.axis.client.Service implements org.alfresco.repo.webservice.authoring.AuthoringService {
 ...
 */
    ...
    public org.alfresco.repo.webservice.authoring.AuthoringServiceSoapPort getAuthoringService() throws javax.xml.rpc.ServiceException {
    ...
    public org.alfresco.repo.webservice.authoring.AuthoringServiceSoapPort getAuthoringService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.alfresco.repo.webservice.authoring.AuthoringServiceSoapBindingStub _stub = new org.alfresco.repo.webservice.authoring.AuthoringServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.alfresco.repo.webservice.authoring.AuthoringServiceSoapPort.class.isAssignableFrom(serviceEndpointInterface)) {
                org.alfresco.repo.webservice.authoring.AuthoringServiceSoapBindingStub _stub = new org.alfresco.repo.webservice.authoring.AuthoringServiceSoapBindingStub(new java.net.URL(AuthoringService_address), this);
                _stub.setPortName(getAuthoringServiceWSDDServiceName());
                return _stub;
            }
        }
