...
public class AdministrationServiceLocator extends org.apache.axis.client.Service implements org.alfresco.repo.webservice.administration.AdministrationService {
 ...
 */
    ...
    public org.alfresco.repo.webservice.administration.AdministrationServiceSoapPort getAdministrationService() throws javax.xml.rpc.ServiceException {
    ...
    public org.alfresco.repo.webservice.administration.AdministrationServiceSoapPort getAdministrationService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.alfresco.repo.webservice.administration.AdministrationServiceSoapBindingStub _stub = new org.alfresco.repo.webservice.administration.AdministrationServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.alfresco.repo.webservice.administration.AdministrationServiceSoapPort.class.isAssignableFrom(serviceEndpointInterface)) {
                org.alfresco.repo.webservice.administration.AdministrationServiceSoapBindingStub _stub = new org.alfresco.repo.webservice.administration.AdministrationServiceSoapBindingStub(new java.net.URL(AdministrationService_address), this);
                _stub.setPortName(getAdministrationServiceWSDDServiceName());
                return _stub;
            }
        }
