...
public class AuthenticationServiceLocator extends org.apache.axis.client.Service implements org.alfresco.repo.webservice.authentication.AuthenticationService {
 ...
 */
    ...
    public org.alfresco.repo.webservice.authentication.AuthenticationServiceSoapPort getAuthenticationService() throws javax.xml.rpc.ServiceException {
    ...
    public org.alfresco.repo.webservice.authentication.AuthenticationServiceSoapPort getAuthenticationService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.alfresco.repo.webservice.authentication.AuthenticationServiceSoapBindingStub _stub = new org.alfresco.repo.webservice.authentication.AuthenticationServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.alfresco.repo.webservice.authentication.AuthenticationServiceSoapPort.class.isAssignableFrom(serviceEndpointInterface)) {
                org.alfresco.repo.webservice.authentication.AuthenticationServiceSoapBindingStub _stub = new org.alfresco.repo.webservice.authentication.AuthenticationServiceSoapBindingStub(new java.net.URL(AuthenticationService_address), this);
                _stub.setPortName(getAuthenticationServiceWSDDServiceName());
                return _stub;
            }
        }
