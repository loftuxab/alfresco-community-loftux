...
{
    private static final long serialVersionUID = 4078929104942308726L;

    public CmisTypePolicyDefinitionType()
    {
    }

    public CmisTypePolicyDefinitionType(java.lang.String id, java.lang.String localName, org.apache.axis.types.URI localNamespace, java.lang.String displayName,
    ...
    {
        if (!(obj instanceof CmisTypePolicyDefinitionType))
            return false;
        if (obj == null)
            return false;
        if (this == obj)
    ...
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(CmisTypePolicyDefinitionType.class, true);

    static
    {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://docs.oasis-open.org/ns/cmis/core/200901", "cmisTypePolicyDefinitionType"));
    }
