...
import org.alfresco.web.scripts.servlet.PageRendererServlet.CacheValue;
...
public class RegionDirective implements TemplateDirectiveModel
{
   ...
   public RegionDirective(
         Store store, Map<String, CacheValue<PageComponent>> cache, PageInstance page, boolean active)
   {
      if (store == null)
      {
