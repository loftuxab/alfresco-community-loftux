...
public class RemoteConfigElement extends ConfigElementAdapter implements RemoteConfigProperties
{
    ...
    {
    	return toStringArray(this.connectors.keySet().toArray());
    }
    ...
    {
    	return toStringArray(this.authenticators.keySet().toArray());
    }
    ...
    {
    	return toStringArray(this.endpoints.keySet().toArray());
    }
    ...
    {
    	return toStringArray(this.credentialVaults.keySet().toArray());
    }
    ...
    {    	
		...
		{
			return getStringProperty(DEFAULT_URI);
		}
