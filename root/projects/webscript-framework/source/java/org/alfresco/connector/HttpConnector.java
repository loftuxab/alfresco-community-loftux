...
/**
 * Basic Connector implementation that can be used to perform simple
 * HTTP and HTTP communication with a remote endpoint.  This connector
...
public class HttpConnector extends AbstractConnector
{
    ...
    public Response call(String uri, Map parameters, Map headers)
    {
        ...
        // No Authentication challenges are responded to - the auth method never gets fired
