...
<script type="text/javascript" src="${url.context}/yui/element/element-beta-min.js"></script>
...
<script type="text/javascript" src="${url.context}/yui/editor/editor-beta-min.js"></script>
