 ...
 * @author muzquiano
 */
public class MarkupComponentType extends AbstractProcessor
{
    public String head(WrappedRenderContext rendererContext)
	...
	public void execute(WrappedRenderContext rendererContext)
            throws RendererExecutionException
    {
