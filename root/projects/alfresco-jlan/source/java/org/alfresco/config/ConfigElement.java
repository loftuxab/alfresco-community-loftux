...
public class ConfigElement {
   ...
   */
  public final ConfigElement getChild(String name) {
    if ( m_children != null) {
   ...
   */
  public final List<ConfigElement> getChildren() {
    return m_children;
  }
   ...
   */
  public final void addAttribute( String attrName, String attrVal) {
    if ( m_attributes == null)
   ...
   */
  public final void addChild( ConfigElement child) {
    if ( m_children == null)
