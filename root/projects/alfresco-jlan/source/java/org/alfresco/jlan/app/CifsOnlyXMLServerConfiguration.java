...
/*
 * CifsOnlyXMLServerConfiguration.java
 *
 ...
 * 
 * <p>XML implementation of the SMB server configuration.
 */
public class CifsOnlyXMLServerConfiguration extends ServerConfiguration {
  ...
  private static final String m_sessDbgStr[] = { "NETBIOS",
	...
	private static final int DEFAULT_SESSDEBUG = SMBSrvSession.DBG_ERROR 	+
																							 SMBSrvSession.DBG_INFO  	+
																							 SMBSrvSession.DBG_SEARCH +
																							 SMBSrvSession.DBG_TREE   +
																							 SMBSrvSession.DBG_TRAN   +
																							 SMBSrvSession.DBG_STATE;
  ...
  */
   public void loadConfiguration(Document doc)
	 ...
	 * 
	 * @param host Element
   * 2param cifsConfig CIFSConfigSection
	 * @exception InvalidConfigurationException
	 */
   ...
   * @param secConfig SecutiryConfigSection
	...
	protected final AccessControlList procAccessControlElement(Element acl, SecurityConfigSection secConfig)
			  ...
			  if ( node.getNodeType() == ELEMENT_TYPE) {
			    ...
			    //	Access the ACL element
					...
					for ( int j = 0; j < attrs.getLength(); j++) {
						...
						//	Create a name/value pair from the current attribute and add to the parameter list
		...
		//	Check if there are no access control rules but the default access level is set to 'None', this is not allowed
   ...
   * @param secConfig SecurityConfigSection
	 ...
	 * 
	 * @param disk Element
   * 2param filesysConfig FilesystemConfigSection
	 * @exception InvalidConfigurationException
	 */
