 ...
 * 
 * <p>A NetBIOSPacket holds a single NetBIOS request or response. Contains methods for building the main NetBIOS request types (add name,
 * delete name, name query, refresh and session setup).
 */
