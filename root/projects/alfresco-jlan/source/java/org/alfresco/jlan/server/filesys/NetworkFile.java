...
/**
 * <p>The network file represents a file or directory on a filesystem. The server keeps track of the open
 * files on a per session basis.
 *
 * <p>This class may be extended as required by your own disk driver class.
 */
public abstract class NetworkFile {
  ...
  protected int m_writeCount;
	...
	//	List of locks on this file by this session. The lock object will almost certainly be referenced
	//	elsewhere depending upon the LockManager implementation used. If locking support is not enabled
	//	for the DiskInterface implementation the lock list will not be allocated.
	//
	//	This lock list is used to release locks on the file if the session abnormally terminates or closes
