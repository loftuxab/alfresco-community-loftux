...
class PipeLanmanHandler {
  ...
  public final static boolean processRequest(TransactBuffer tbuf, SMBSrvSession sess, SMBSrvPacket trans)
    ...
    switch (cmd) {
      ...
      default :
        ...
        if (Debug.EnableInfo && sess.hasDebug(SMBSrvSession.DBG_IPC))
          sess.debugPrintln("No handler for \\PIPE\\LANMAN\\ request, cmd=" + cmd + ", prm=" + prmDesc + ", data=" + dataDesc);
        break;
    }
   ...
   */
  protected final static boolean procNetServerGetInfo(SMBSrvSession sess, TransactBuffer tbuf, String prmDesc, String dataDesc, SMBSrvTransPacket tpkt)
    throws IOException, SMBSrvException {
   ...
   * @return          true if the transaction has been processed, else false.
   */
  protected final static boolean procNetShareEnum(SMBSrvSession sess, TransactBuffer tbuf, String prmDesc, String dataDesc, SMBSrvTransPacket tpkt)
    throws IOException, SMBSrvException {
   ...
   * @return          true if the transaction has been processed, else false.
   */
  protected final static boolean procNetShareGetInfo(SMBSrvSession sess, TransactBuffer tbuf, String prmDesc, String dataDesc, SMBSrvTransPacket tpkt)
    throws IOException, SMBSrvException {
    ...
    if (infoLevel == 1 && dataDesc.compareTo("B13BWz") == 0) {
      ...
      if (Debug.EnableInfo && sess.hasDebug(SMBSrvSession.DBG_IPC))
        sess.debugPrintln("NetShareGetInfo - UNSUPPORTED " + shareName + ", infoLevel=" + infoLevel + ", dataDesc=" + dataDesc);
   ...
   * @return          true if the transaction has been processed, else false.
   */
  protected final static boolean procNetWkstaGetInfo(SMBSrvSession sess, TransactBuffer tbuf, String prmDesc, String dataDesc, SMBSrvTransPacket tpkt)
    throws IOException, SMBSrvException {
   ...
   * @return          true if the transaction has been processed, else false.
   */
  protected final static boolean procNetPrintQGetInfo(SMBSrvSession sess, TransactBuffer tbuf, String prmDesc, String dataDesc, SMBSrvTransPacket tpkt)
    throws IOException, SMBSrvException {
