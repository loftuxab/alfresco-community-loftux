...
//    m_offset = getParameterOffset();
  ...
  public DCESrvPacket(int siz) {
	...
	/**
	 * Initialize the DCE/RPC request. Set the SMB transaction parameter count so that the
	 * data offset can be calculated.
	 * 
	 * @param handle int
	 * @param typ byte
	 * @param flags int
	...
	/**
	 * Initialize the DCE/RPC reply. Set the SMB transaction parameter count so that the
	 * data offset can be calculated.
	 */
