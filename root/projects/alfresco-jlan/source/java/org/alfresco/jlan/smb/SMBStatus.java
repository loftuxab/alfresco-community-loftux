 ...
 *
 *  <p>The SMBStatus class contains the error class and error code values that a
 *  remote server may return.
 *
 *  <p>The available error classes are defined below :-
 *
 *  <p><table border="1" cellpadding="0" cellspacing="0" width="80%">
 *  <tr>
