...
public class Win32NetBIOS {
  ...
  public static final String getAdapterNameForLANA(int lana) {
    ...
    Hashtable adapters = getNetworkAdapterList();
    ...
    if ( adapters != null) {
      ...
      NetworkInterface ni = (NetworkInterface) adapters.get(ipAddr);
      if ( ni != null)
  ...
  public static final int getLANAForAdapterName(String name) {
    ...
    Hashtable niList = getNetworkAdapterList();
    
    //	Search for the address of the specified network adapter
    
    Enumeration niEnum = niList.keys();
    
    while ( niEnum.hasMoreElements()) {
      
      //	Get the current TCP/IP address
      
      String ipAddr = (String) niEnum.nextElement();
  ...
  private static final Hashtable getNetworkAdapterList() {
    ...
    Hashtable niList = new Hashtable();
      ...
      //	Enumerate the available network adapters
	    ...
	    while ( niEnum.hasMoreElements()) {
	      ...
	      while ( addrEnum.hasMoreElements()) {
	        ...
	        //	Get the address and add the adapter to the list indexed via the numeric IP address string
