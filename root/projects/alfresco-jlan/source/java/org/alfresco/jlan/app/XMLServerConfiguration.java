 ...
 * 
 * <p>XML implementation of the SMB server configuration. Save/load the server configuration to an XML format
 * file using the DOM API.
 */
public class XMLServerConfiguration extends CifsOnlyXMLServerConfiguration {
	...
	private static final String m_ftpDebugStr[] = { "STATE",
																									"RXDATA",
																									"TXDATA",
																									"DUMPDATA",
																									"SEARCH",
	...
	private static final String m_nfsDebugStr[] = { "RXDATA",
																									"TXDATA",
																									"DUMPDATA",
																									"SEARCH",
																									"INFO",
  ...
  */
   ...
   public final boolean isNFSServerEnabled() {
	...
	protected final void procServersElement(Element servers)
	  ...
	  //	Check if the servers element has been specified, if not then this is an old format configuration
	...
	protected final void procFTPServerElement(Element ftp)
		...
		if ( ftp == null) {
			...
			//	Check if the FTP server is enabled, if so then there must be an FTP configuration section
