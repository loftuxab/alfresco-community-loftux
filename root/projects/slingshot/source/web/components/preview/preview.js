...
(function()
{
   ...
   Alfresco.Preview.prototype =
   {
       ...
       */
      onComponentsLoaded: function D_onComponentsLoaded()
      {
       ...
       */
      _resolvePreview: function D__resolvePreview(event)
      {
       ...
       */
      onContentReady: function D_onContentReady(event)
      {
         if(!this.ready)
         {
            this.ready = true;
       ...
       */
      onLoadedSwfError: function D_onLoadedSwfError(event)
      {
       ...
       */
      onLoadedSwfReady: function D_onLoadedSwfReady(event)
      {
       ...
       */
      onLoadedSwfOnFrame: function D_onLoadedSwfOnFrame(event)
      {
         this._handleSuccessFullLoadedSwfEvent(event);
      },
       ...
       */
      _handleSuccessFullLoadedSwfEvent: function D__handleSuccessFullLoadedSwfEvent(event)
      {
       ...
       */
      onJumpToPageTextFieldChange: function D_onJumpToPageTextFieldChange(event)
      {
       ...
       */
      onPreviousButtonClick: function D_onPreviousButtonClick()
      {
       ...
       * @param event {object} a Button "click" event
       */
      onNextButtonClick: function D_onNextButtonClick()
      {
         this.swfPlayer.goToFrameNo(this.loadedSwf.currentFrame + 1);
      },
       ...
       * @param event {object} a Button "click" event
       */
      onFullPreviewButtonClick: function D_onFullPreviewButtonClick()
      {
         alert('Fullscreen');
      }
