...
/**
 * DocumentList Tags component.
 * 
 * @namespace Alfresco
 * @class Alfresco.DocListTags
 */
(function()
{
   /**
    ...
    * @return {Alfresco.DocListTags} The new DoclistTags instance
    * @constructor
    */
   ...
   Alfresco.DocListTags.prototype =
   {
       ...
       * @return {Alfresco.DocListTags} returns 'this' for method chaining
       */
       setOptions: function DLTg_setOptions(obj)
       {
       ...
       */
      onComponentsLoaded: function DLTg_onComponentsLoaded()
      {
       ...
       */
      onFilterChanged: function DLTg_onFilterChanged(layer, args)
      {
         var obj = args[1];
       ...
       * @private
       */
      _msg: function DLTg__msg(messageId)
      {
         return Alfresco.util.message.call(this, messageId, "Alfresco.DocListTags", Array.prototype.slice.call(arguments).slice(1));
      },
       ...
       */
      _generateTagId: function DLTg__generateTagId(tagName)
      {
         var id = 0;
