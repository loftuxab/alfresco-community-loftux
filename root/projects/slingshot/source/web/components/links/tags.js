...
/**
 * Links Tags component.
 *
 * @namespace Alfresco
 * @class Alfresco.LinkTags
 */
(function()
{
   /**
   ...
   /**
    * Link Tags constructor.
    *
    * @param {String} htmlId The HTML id of the parent element
    * @return {Alfresco.LinkTags} The new DoclistTags instance
    * @constructor
    */
   Alfresco.LinkTags = function(htmlId)
   {
      /* Mandatory properties */
      this.name = "Alfresco.LinkTags";
      this.id = htmlId;
   ...
   Alfresco.LinkTags.prototype =
   {
       ...
       * @return {Alfresco.LinkTags} returns 'this' for method chaining
       */
      setOptions: function LinkTags_setOptions(obj)
      {
       ...
       */
      onComponentsLoaded: function LinkTags_onComponentsLoaded()
      {
       ...
       * @method onReady
       */
      onReady: function LinkTags_onReady()
      {
         var me = this;
       ...
       * @param args {object} arguments object
       */
      onTagRefresh: function LinkTags_onRefresh(layer, args)
      {
       ...
       */
      onTagRefresh_success: function LinkTags_onTagRefresh_success(response)
      {
       ...
       */
      onDeactivateAllControls: function LinkTags_onDeactivateAllControls(layer, args)
      {
       ...
       * @private
       */
      _msg: function LinkTags__msg(messageId)
      {
         return Alfresco.util.message.call(this, messageId, "Alfresco.LinkTags", Array.prototype.slice.call(arguments).slice(1));
      },
       ...
       */
      _generateTagId: function LinkTags__generateTagId(tagName)
      {
         var id = 0;
