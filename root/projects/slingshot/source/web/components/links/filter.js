...
/**
 * LinkFilter component.
 * 
 * @namespace Alfresco
 * @class Alfresco.LinkFilter
 */
(function()
{
   /**
    ...
    * @return {Alfresco.LinkFilter} The new LinkFilter instance
    * @constructor
    */
   Alfresco.LinkFilter = function(htmlId)
   {
      this.name = "Alfresco.LinkFilter";
      this.id = htmlId;
   ...
   Alfresco.LinkFilter.prototype =
   {
       ...
       */
      onComponentsLoaded: function LinkFilter_onComponentsLoaded()
      {
       ...
       * @method onReady
       */
      onReady: function LinkFilter_onReady()
      {
         var me = this;
         
         YAHOO.Bubbling.addDefaultAction("filter-link", function LinkFilter_filterAction(layer, args)
         {
       ...
       */
      onFilterChanged: function LinkFilter_onFilterChanged(layer, args)
      {
         var obj = args[1];
       ...
       */
      onDeactivateAllControls: function LinkFilter_onDeactivateAllControls(layer, args)
      {
