...
YAHOO.widget.FlashAdapter=function(C,A,B,params)
{
...
YAHOO.extend(YAHOO.widget.FlashAdapter,YAHOO.util.AttributeProvider,{_swfURL:null,_swf:null,_id:null,_attributes:null,toString:function(){return"FlashAdapter "+this._id;},

_embedSWF:function(H,G,C,B,E,F)
{
  var D=new deconcept.SWFObject(H,C,"100%","100%",B,E,F);
  
  //Alfresco YUI FIX - start		
  for (var p in this._params)
  {
	swfObj.addParam(p, this._params[p]);
  }		
  // Alfresco YUI FIX - end		 
