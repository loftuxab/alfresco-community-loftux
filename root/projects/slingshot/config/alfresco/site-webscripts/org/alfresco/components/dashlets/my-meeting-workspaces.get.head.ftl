...
<!-- My Sites -->
<@link rel="stylesheet" type="text/css" href="${page.url.context}/components/dashlets/my-meeting-workspaces.css" />
<@script type="text/javascript" src="${page.url.context}/components/dashlets/my-meeting-workspaces.js"></@script>
<!-- Create Site -->
