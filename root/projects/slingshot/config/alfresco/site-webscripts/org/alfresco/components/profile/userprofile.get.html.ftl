...
<div id="${args.htmlid}-body" class="profile">
      ...
      <div class="viewcolumn">
         ...
         <div class="row">
            ...
            <span class="fieldvalue">
               <#if user.companyAddress1?exists><p>${user.companyAddress1?html}</p></#if>
   ...
   <div id="${args.htmlid}-editview" class="hidden">
      ...
      <div class="row">
         ...
         <span class="input"><textarea id="${args.htmlid}-input-bio" name="${args.htmlid}-input-bio" rows="5" cols="60">${user.biography!""}</textarea></span>
      </div>
