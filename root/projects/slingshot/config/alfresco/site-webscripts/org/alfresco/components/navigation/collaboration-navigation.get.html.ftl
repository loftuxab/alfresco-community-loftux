<div class="site-navigation">
   <span class="navigation-menu-item"><a href="${url.context}/page/collaboration/dashboard?site=${page.url.args.site}">Site Dashboard</a></span>
   <span class="navigation-separator">|</span>
   <span class="navigation-menu-item"><a href="#">Wiki</a></span>
   <span class="navigation-separator">|</span>
