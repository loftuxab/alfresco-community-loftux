...
<div id="${args.htmlid}-body" class="doclist">
   ...
   <div style="display:none">
      ...
      <div id="${args.htmlid}-actionSet-document" class="action-set">
         <div class="onActionDownload"><a href="#" class="action-link" title="${msg("actions.document.download")}"><span>${msg("actions.document.download")}</span></a></div>
         ...
         <div class="more-actions hidden">
            ...
            <div class="onActionDeleteAsset"><a href="#" class="action-link" title="${msg("actions.document.delete")}"><span>${msg("actions.document.delete")}</span></a></div>
         </div>
      </div>
      ...
      <div id="${args.htmlid}-actionSet-folder" class="action-set">
         ...
         <div class="onActionDeleteAsset"><a href="#" class="action-link" title="${msg("actions.folder.delete")}"><span>${msg("actions.folder.delete")}</span></a></div>
      </div>
   </div>
