...
<#if role = "SiteCollaborator" || role = "SiteManager">
         ...
         <div class="ical-feed">
            <a id="${args.htmlid}-publishEvents-button" href="${page.url.context}/proxy/alfresco-rss/calendar/eventList?site=${page.url.templateArgs["site"]}&amp;format=calendar" rel="_blank">${msg("button.ical")}</a>
         </div>
      </div> 
      <div class="yui-u align-right">
         ...
         <div id="${args.htmlid}-navigation" class="yui-buttongroup inline">
            ...
            <input id="${args.htmlid}-day" type="radio" name="navigation" value="${msg("button.day")}" /><input id="${args.htmlid}-week" type="radio" name="navigation" value="${msg("button.week")}" /><input id="${args.htmlid}-month" type="radio" name="navigation" value="${msg("button.month")}" checked="checked" /><input id="${args.htmlid}-agenda" type="radio" name="navigation" value="${msg("button.agenda")}" />
         </div>
         <span class="separator">&nbsp;</span>
