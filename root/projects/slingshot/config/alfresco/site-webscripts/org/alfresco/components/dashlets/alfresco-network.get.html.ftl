...
<div class="dashlet">
   ...
   <div class="body scrollablePanel" <#if args.height??>style="height: ${args.height}px;"</#if>>
      <div class="detail-list-item">
         ...
         <p><a href="http://www.alfresco.com/services/subscription/" rel="_blank"><img src="${url.context}/components/images/network-dashlet-button.png" alt="Learn More" width="97" height="28" /></a></p>
      </div>
   </div>
</div>
