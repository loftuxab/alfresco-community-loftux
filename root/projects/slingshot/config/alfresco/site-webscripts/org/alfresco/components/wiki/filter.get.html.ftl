...
<div id="${args.htmlid}-body" class="filter wiki-filter">
   ...
   <ul class="filterLink">
      <li id="${args.htmlid}-main"><span class="recentlyModified"><a href="${url.context}/page/site/${page.url.templateArgs.site!""}/wiki-page?filter=main&title=Main_Page" class="filter-link">${msg("link.mainPage")}</a></span></li>   
