...
<@script type="text/javascript" src="${page.url.context}/js/alfresco-location.js"></@script>
...
<!-- Workflow -->
<@link rel="stylesheet" type="text/css" href="${page.url.context}/modules/rules/actions/workflow.css" />
<@script type="text/javascript" src="${page.url.context}/modules/rules/actions/workflow.js"></@script>
<!-- Checkin -->
<@link rel="stylesheet" type="text/css" href="${page.url.context}/modules/rules/actions/checkin.css" />
<@script type="text/javascript" src="${page.url.context}/modules/rules/actions/checkin.js"></@script>
<!-- Email Form -->
<@link rel="stylesheet" type="text/css" href="${page.url.context}/components/people-finder/authority-finder.css" />
<@script type="text/javascript" src="${page.url.context}/components/people-finder/authority-finder.js"></@script>
...
<@script type="text/javascript" src="${page.url.context}/modules/rules/rules-property-picker.js"></@script>
<!-- Categories and Tags -->
