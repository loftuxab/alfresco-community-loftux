...
<div class="path-nav">
   ...
   <#assign href>${url.context}/page/site/${page.url.templateArgs.site}/documentlibrary</#assign>
   <span id="${args.htmlid}-defaultPath" class="path-link"><a href="${siteURL(href)}">${msg("path.documents")}</a></span>
