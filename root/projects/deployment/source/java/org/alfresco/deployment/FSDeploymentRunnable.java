...
public interface FSDeploymentRunnable extends Runnable, Serializable
{
     ...
     * @param deployment The deployment that just succeeded.
     * The log of the deployment will have been reset just before this
     * is called so that the runnable can run through the log if desired.
     */
