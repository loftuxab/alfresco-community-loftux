...
<%
	// query for customers
	//String sql = "SELECT CLIENT.CLIENT_ID, CLIENT.USER_NAME, CLIENT.FIRST_NAME, CLIENT.LAST_NAME, CLIENT.EMAIL, LOCATION.LOCATION_NAME from CLIENT, LOCATION where CLIENT.DELETED = 0 AND LOCATION.LOCATION_ID = CLIENT.LOCATION_ID AND LOCATION.GROUP_ID = 3";
	String sql = "SELECT CLIENT.CLIENT_ID, CLIENT.USER_NAME, CLIENT.FIRST_NAME, CLIENT.LAST_NAME, CLIENT.EMAIL, LOCATION.LOCATION_NAME from CLIENT, LOCATION where CLIENT.DELETED = 0 AND LOCATION.LOCATION_ID = CLIENT.LOCATION_ID";
