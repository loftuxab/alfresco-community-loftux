...
YAHOO.util.Event.onDOMReady(function() {
    YAHOO.example.ClientPagination = new function() {
        ...
        this.myDataSource = new YAHOO.util.DataSource("/extranet/proxy/alfresco/kb/advancedsearchresults.json?searchText="+document.getElementById('searchText').value+"&article_type="+document.getElementById('article_type').value+"&alfresco_version="+alfresco_version+"&");
