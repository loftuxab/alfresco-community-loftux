...
import org.alfresco.extranet.database.DatabaseCompany;
    ...
    implements ApplicationContextAware, EntityService
{
    ...
    {
        return this.databaseService.getCompany(entityId);
    }
    ...
    {
        return this.databaseService.getAllCompanies();
    }
    ...
    {
        return this.databaseService.insertCompany((DatabaseCompany)entity);
    }
    ...
    {
        return this.databaseService.updateCompany((DatabaseCompany)entity);
    }
    ...
    {
        return this.databaseService.removeCompany((DatabaseCompany)entity);
    }
}
