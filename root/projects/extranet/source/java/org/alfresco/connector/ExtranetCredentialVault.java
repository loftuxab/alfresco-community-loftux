...
/**
 * A credential vault implementation that uses a MySQL back end to 
 * store credentials.
 * 
 * @author muzquiano
 */
public class ExtranetCredentialVault implements CredentialVault
{
    public static Map<String, Credentials> credentials = null;

    public ExtranetCredentialVault()
    {
    }
    ...
    public void load()
    {
        this.credentials = new HashMap<String, Credentials>(16, 1.0f);
    }
