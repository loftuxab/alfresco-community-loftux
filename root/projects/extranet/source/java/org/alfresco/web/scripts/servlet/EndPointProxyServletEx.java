...
/**
 * This is a temporary class which was added pretty late in the game
 * prior to the Alfresco 3.0 Labs 1 launch.  As such, it basically 
 * implements a feature that we'd like to add to the EndPointProxyServlet.
 * 
 * This feature is simply the ability for the proxy servlet to allow
 * "guest mode" connectors to be utilized.
 * 
 * The code which is to be merged is marked with TODO's
 */
public class EndPointProxyServletEx extends HttpServlet
{
    // TODO: Merge this static variable
    public static final String UNAUTHENTICATED_MODE_GUEST = "guest";
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
            ...
            // TODO: Merge fetch of Connector Descriptor
            // retrieve the connector descriptor
            ConnectorDescriptor connectorDescriptor = this.config.getConnectorDescriptor(descriptor.getConnectorId());
            if(connectorDescriptor == null)
            {
                // throw an exception if the connector id does not exist or is invalid
                throw new AlfrescoRuntimeException("Invalid Connector Id: " + descriptor.getConnectorId());
            }
            ...
            else if(UNAUTHENTICATED_MODE_GUEST.equals(connectorDescriptor.getUnauthenticatedMode()))
            {
                // TODO: Merge this check and allowance
                // TODO: Collapse into prior conditional above
                
                // build an unauthenticated connector
                connector = this.connectorService.getConnector(endpointId);                
            }
            else
            {
