...
public class LDAPSinglePersonExportSource extends LDAPPersonExportSource
{
    protected String originalSearchBase;
    
    public LDAPSinglePersonExportSource()
    {
        super();
    }
    ...
    public void setSearchBase(String searchBase)
    {
        ...
        if(this.originalSearchBase == null)
        {
            this.originalSearchBase = searchBase;
        }
    }
