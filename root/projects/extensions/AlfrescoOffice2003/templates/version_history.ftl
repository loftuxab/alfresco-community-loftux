...
<div id="tabBar">
    <ul>
      ...
      <li id="current"><a href="#"><img src="/alfresco/images/office/version_history.gif" border="0" alt="View Version History" /></a></li>
    </ul>
  </div>
...
<#if document.isDocument >
   <#if hasAspect(document, "cm:versionable") == 1 >
      ...
      <#list document.versionHistory?sort_by("versionLabel")?reverse as record>
                   <tr>
                       <td valign="top">
                       <a href="/alfresco${document.url}"><img src="/alfresco/images/office/document.gif" border="0" alt="Open ${record.versionLabel}"/></a>
                       </td>
