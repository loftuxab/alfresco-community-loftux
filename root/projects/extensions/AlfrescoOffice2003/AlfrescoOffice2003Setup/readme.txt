Alfresco Add-In for Microsoft Word, Excel and Powerpoint 2003
=============================================================
...
** INSTALLATION
 ...
 3. The Add-In will launch automatically the next time Word, Excel or PowerPoint 2003 is launched.
...
** CONFIGURATION
 ...
 1. If no configuration is found, the Add-In will display the settings screen. You are encouraged to
    fill-in all settings and select "Remember authentication details" for the best experience. The
    Add-In will copy settings from the Word 2003 Add-In if they are available.

 2. The Add-In will try to help with the correct settings once the Web Client URL is set.

 3. The Add-Ins share one server configuration, so you only need to set the values once.
...
** TROUBLESHOOTING / FAQ
 ...
 A: Clicking the Alfresco toolbar button in the PowerPoint application will show (and hide) the panel.
