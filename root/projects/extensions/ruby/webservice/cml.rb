...
# {http://www.alfresco.org/ws/cml/1.0}CML
class CML
  @@schema_type = "CML"
  @@schema_ns = "http://www.alfresco.org/ws/cml/1.0"
  @@schema_element = [["create", nil], ["addAspect", nil], ["removeAspect", nil], ["update", nil], ["delete", nil], ["move", nil], ["copy", nil], ["addChild", nil], ["removeChild", nil], ["createAssociation", nil], ["removeAssociation", nil]]

  attr_accessor :create
  attr_accessor :addAspect
  attr_accessor :removeAspect
  attr_accessor :update
  attr_accessor :delete
  attr_accessor :move
  attr_accessor :copy
  attr_accessor :addChild
  attr_accessor :removeChild
  attr_accessor :createAssociation
  attr_accessor :removeAssociation

  def initialize(create = [], addAspect = [], removeAspect = [], update = [], delete = [], move = [], copy = [], addChild = [], removeChild = [], createAssociation = [], removeAssociation = [])
    @create = create
    @addAspect = addAspect
