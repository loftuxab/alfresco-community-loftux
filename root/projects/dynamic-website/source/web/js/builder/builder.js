...
// TODO: unhide frame to bring back grips		
		...
		//
		var url = "/app/regionPageOverlay.jsp?regionId=" + id + "&regionScopeId=" + el.dom.getAttribute("regionScopeId") + "&regionSourceId=" + el.dom.getAttribute("regionSourceId");
		url = toBrowser(url);
		if(el.dom.getAttribute("componentId")  != null)
...
function setupRegionLayoutEditorOverlay(regionId)
{
	...
	if(win == null)
	{
		...
		// Tell the region overlay to load in region information
		//
		//var url = "/app/regionLayoutOverlay.jsp?regionId=" + regionId + "&regionScopeId=" + el.dom.getAttribute("regionScopeId") + "&layoutId=" + el.dom.getAttribute("layoutId") + "&regionSourceId=" + el.dom.getAttribute("regionSourceId");
		//url = toBrowser(url);
		//win.load(url);
