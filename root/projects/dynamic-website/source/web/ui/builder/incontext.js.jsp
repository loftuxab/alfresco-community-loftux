...
function refreshFloatingMenu()
{
	...
	if(currentlyEnabled)
	{
		...
		if(floatingMenuImg != null)
			floatingMenuImg.dom.src = toBrowser("/ui/themes/builder/images/default/icons/incontext/disable_edit_mode.gif");
	}
	else
	{
		if(floatingMenuTextSpan != null)
		...
		if(floatingMenuImg != null)
			floatingMenuImg.dom.src = toBrowser("/ui/themes/builder/images/default/icons/incontext/enable_edit_mode.gif");
	}
