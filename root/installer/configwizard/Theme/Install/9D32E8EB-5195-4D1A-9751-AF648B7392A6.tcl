proc CreateWindow.9D32E8EB-5195-4D1A-9751-AF648B7392A6 {wizard id} {
    ...
    ttk::label $base.clientarea.label -text "OpenOffice Location"
    grid $base.clientarea.label -row 0 -column 0 -sticky w -padx 10 -pady 2

    ttk::entry $base.clientarea.entry -textvariable ::info(ALF_OO)
    grid $base.clientarea.entry -row 1 -column 0 -sticky new -padx {10 0} -pady 1

    ttk::button $base.clientarea.browse -text "..." -width 3 -command [list ::InstallAPI::PromptForDirectory -virtualtext ALF_OO]
