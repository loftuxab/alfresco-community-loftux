proc CreateWindow.58DBE5C1-8F57-49EE-8CC8-1203885300ED {wizard id} {
    ...
    ttk::label $base.clientarea.label -text "Default Rmi Port Number"
    grid $base.clientarea.label -row 0 -column 0 -sticky w -padx 10 -pady 2

    ttk::entry $base.clientarea.entry -textvariable ::info(ALF_RMIPORT)
