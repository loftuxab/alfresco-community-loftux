proc CreateWindow.C89B2458-A96B-4399-A74E-E525BBCB659D {wizard id} {
    ...
    ttk::label $base.clientarea.label -text "Default Tomcat Port Number"
    grid $base.clientarea.label -row 0 -column 0 -sticky w -padx 10 -pady 2

    ttk::entry $base.clientarea.entry -textvariable ::info(ALF_TOMCATPORT)
