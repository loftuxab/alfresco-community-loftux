proc CreateWindow.8E3926B9-D3BB-3572-A31E-1A158E404977 {wizard id} {
    ...
    grid rowconfigure    $base.clientarea 6 -weight 2
    grid columnconfigure $base.clientarea 2 -weight 2

    ttk::label $base.clientarea.label1 -text "monitorRole :" 
    grid $base.clientarea.label1 -row 0 -column 0 

    ttk::entry $base.clientarea.entry1 -textvariable ::info(JMX_MONITORROLE_PWD) -show "*"
    grid $base.clientarea.entry1 -row 0 -column 1

    ttk::label $base.clientarea.label2 -text "" 
    grid $base.clientarea.label2 -row 1 -column 0

    
    ttk::label $base.clientarea.label3 -text "controlRole :" 
    grid $base.clientarea.label3 -row 2 -column 0

    ttk::entry $base.clientarea.entry3 -textvariable ::info(JMX_CONTROLROLE_PWD) -show "*"
