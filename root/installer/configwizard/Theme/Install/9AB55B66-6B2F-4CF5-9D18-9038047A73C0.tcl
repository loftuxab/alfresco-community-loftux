proc CreateWindow.9AB55B66-6B2F-4CF5-9D18-9038047A73C0 {wizard id} {
    ...
    ttk::label $base.clientarea.label -text "Index Location"
    grid $base.clientarea.label -row 0 -column 0 -sticky w -padx 10 -pady 2

    ttk::entry $base.clientarea.entry -textvariable ::info(ALF_INDEXES)
    grid $base.clientarea.entry -row 1 -column 0 -sticky new -padx {10 0} -pady 1

    ttk::button $base.clientarea.browse -text "..." -width 3 -command [list ::InstallAPI::PromptForDirectory -virtualtext ALF_INDEXES]
