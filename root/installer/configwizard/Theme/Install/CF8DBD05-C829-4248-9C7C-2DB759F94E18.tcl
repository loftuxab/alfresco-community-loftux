proc CreateWindow.CF8DBD05-C829-4248-9C7C-2DB759F94E18 {wizard id} {
    ...
    ttk::label $base.clientarea.label -text "Content Store Location"
    grid $base.clientarea.label -row 0 -column 0 -sticky w -padx 10 -pady 2

    ttk::entry $base.clientarea.entry -textvariable ::info(ALF_DATA)
    grid $base.clientarea.entry -row 1 -column 0 -sticky new -padx {10 0} -pady 1

    ttk::button $base.clientarea.browse -text "..." -width 3 -command [list ::InstallAPI::PromptForDirectory -virtualtext ALF_DATA]
